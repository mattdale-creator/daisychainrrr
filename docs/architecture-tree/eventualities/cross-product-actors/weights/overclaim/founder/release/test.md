# weights · overclaim · founder · release · test

**Path:** `eventualities/cross-product-actors/weights/overclaim/founder/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · public narrative exceeds what sealed artefacts support · phase at seal/publish time · actor project lead / founder.
