# weights · overclaim · attacker · release · test

**Path:** `eventualities/cross-product-actors/weights/overclaim/attacker/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · public narrative exceeds what sealed artefacts support · phase at seal/publish time · actor external or insider adversary.
