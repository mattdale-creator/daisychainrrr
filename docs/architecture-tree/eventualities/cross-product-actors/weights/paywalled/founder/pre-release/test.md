# weights · paywalled · founder · pre-release · test

**Path:** `eventualities/cross-product-actors/weights/paywalled/founder/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · verification path is gated behind payment or private access · phase before public release or claim · actor project lead / founder.
