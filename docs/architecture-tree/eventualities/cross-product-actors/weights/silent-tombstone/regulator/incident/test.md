# weights · silent-tombstone · regulator · incident · test

**Path:** `eventualities/cross-product-actors/weights/silent-tombstone/regulator/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · missing bone without public tombstone · phase during or after a known incident · actor regulator or auditor.
