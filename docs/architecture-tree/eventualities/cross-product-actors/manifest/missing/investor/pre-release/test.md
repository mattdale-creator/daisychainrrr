# manifest · missing · investor · pre-release · test

**Path:** `eventualities/cross-product-actors/manifest/missing/investor/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · required artefact is absent when a public claim or release depends on it · phase before public release or claim · actor funder or prospective capital.
...
1. Assume **required artefact is absent when a public claim or release depends on it** occurs in phase **before public release or claim** with actor **funder or prospective capital**.
