# manifest · missing · regulator · incident

**Path:** `eventualities/cross-product-actors/manifest/missing/regulator/incident/README.md`  
**Updated:** 2026-08-08  
...
Primary actor context: **regulator or auditor**.
...
2. Manual: release checklist incomplete; public URL/claim lacks linked artefact; actor (regulator or auditor) reports inconsistency.
