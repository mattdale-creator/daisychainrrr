# manifest · missing · attacker · incident

**Path:** `eventualities/cross-product-actors/manifest/missing/attacker/incident/README.md`  
**Updated:** 2026-08-08  
...
Primary actor context: **external or insider adversary**.
...
2. Manual: release checklist incomplete; public URL/claim lacks linked artefact; actor (external or insider adversary) reports inconsistency.
