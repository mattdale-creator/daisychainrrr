# manifest · missing · founder · incident

**Path:** `eventualities/cross-product-actors/manifest/missing/founder/incident/README.md`  
**Updated:** 2026-08-08  
...
Primary actor context: **project lead / founder**.
...
2. Manual: release checklist incomplete; public URL/claim lacks linked artefact; actor (project lead / founder) reports inconsistency.
