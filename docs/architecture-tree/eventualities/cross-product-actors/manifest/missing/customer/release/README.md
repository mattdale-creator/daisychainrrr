# manifest · missing · customer · release

**Path:** `eventualities/cross-product-actors/manifest/missing/customer/release/README.md`  
**Updated:** 2026-08-08  
...
Lifecycle phase: **at seal/publish time**.  
...
3. Phase-specific (at seal/publish time): pre-release CI/manual gate; release seal script; post-release monitor; incident response; acquisition due-diligence freeze.
