# manifest · missing · customer · release · test

**Path:** `eventualities/cross-product-actors/manifest/missing/customer/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · required artefact is absent when a public claim or release depends on it · phase at seal/publish time · actor commercial-layer customer or prospect.
...
1. Assume **required artefact is absent when a public claim or release depends on it** occurs in phase **at seal/publish time** with actor **commercial-layer customer or prospect**.
