# manifest · tampered · founder · release · test

**Path:** `eventualities/cross-product-actors/manifest/tampered/founder/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · content no longer matches published hash / expected state · phase at seal/publish time · actor project lead / founder.
