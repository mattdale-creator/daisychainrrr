# manifest · tampered · attacker · pre-release · prevent

**Path:** `eventualities/cross-product-actors/manifest/tampered/attacker/pre-release/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **manifest** · content no longer matches published hash / expected state · phase before public release or claim · actor external or insider adversary.
