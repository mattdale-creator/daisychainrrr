# manifest · unsigned · regulator · release · test

**Path:** `eventualities/cross-product-actors/manifest/unsigned/regulator/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · release or index lacks required signature or seal · phase at seal/publish time · actor regulator or auditor.
...
1. Assume **release or index lacks required signature or seal** occurs in phase **at seal/publish time** with actor **regulator or auditor**.
