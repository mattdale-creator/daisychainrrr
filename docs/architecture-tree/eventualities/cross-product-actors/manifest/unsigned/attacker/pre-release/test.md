# manifest · unsigned · attacker · pre-release · test

**Path:** `eventualities/cross-product-actors/manifest/unsigned/attacker/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · release or index lacks required signature or seal · phase before public release or claim · actor external or insider adversary.
