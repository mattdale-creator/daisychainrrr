# manifest · paywalled · investor · incident · test

**Path:** `eventualities/cross-product-actors/manifest/paywalled/investor/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · verification path is gated behind payment or private access · phase during or after a known incident · actor funder or prospective capital.
