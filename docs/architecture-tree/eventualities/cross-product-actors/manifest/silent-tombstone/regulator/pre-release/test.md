# manifest · silent-tombstone · regulator · pre-release · test

**Path:** `eventualities/cross-product-actors/manifest/silent-tombstone/regulator/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · missing bone without public tombstone · phase before public release or claim · actor regulator or auditor.
