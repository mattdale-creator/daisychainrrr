# data · unsigned · founder · release · respond

**Path:** `eventualities/cross-product-actors/data/unsigned/founder/release/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **data** · release or index lacks required signature or seal · phase at seal/publish time · actor project lead / founder.
