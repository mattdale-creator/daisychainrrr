...
**Path:** `eventualities/cross-product-actors/data/tampered/attacker/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **data** · content no longer matches published hash / expected state · phase at seal/publish time · actor external or insider adversary.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product-actors/data/tampered/attacker/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
