# data · tampered · attacker · release · test

**Path:** `eventualities/cross-product-actors/data/tampered/attacker/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **data** · content no longer matches published hash / expected state · phase at seal/publish time · actor external or insider adversary.
