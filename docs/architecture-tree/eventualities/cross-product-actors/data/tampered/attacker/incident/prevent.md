# data · tampered · attacker · incident · prevent

**Path:** `eventualities/cross-product-actors/data/tampered/attacker/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **data** · content no longer matches published hash / expected state · phase during or after a known incident · actor external or insider adversary.
