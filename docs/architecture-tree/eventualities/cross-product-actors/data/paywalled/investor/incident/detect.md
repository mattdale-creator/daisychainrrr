# data · paywalled · investor · incident · detect

**Path:** `eventualities/cross-product-actors/data/paywalled/investor/incident/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **data** · verification path is gated behind payment or private access · phase during or after a known incident · actor funder or prospective capital.
...
3. Compare published claims (site, README, scorecard) to artefacts under `models/*/data/ + DATA_CARD.md`.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product-actors/data/paywalled/investor/incident/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
