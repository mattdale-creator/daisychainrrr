# stream · missing · regulator · incident · prevent

**Path:** `eventualities/cross-product-actors/stream/missing/regulator/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **stream** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor regulator or auditor.
