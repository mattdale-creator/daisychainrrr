# stream · missing · customer · pre-release · respond

**Path:** `eventualities/cross-product-actors/stream/missing/customer/pre-release/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **stream** · required artefact is absent when a public claim or release depends on it · phase before public release or claim · actor commercial-layer customer or prospect.
...
4. **Remediate:**
   - Restore or regenerate artefact under `models/*/stream/public_log.json`
