...
**Path:** `eventualities/cross-product-actors/stream/missing/customer/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **stream** · required artefact is absent when a public claim or release depends on it · phase before public release or claim · actor commercial-layer customer or prospect.
