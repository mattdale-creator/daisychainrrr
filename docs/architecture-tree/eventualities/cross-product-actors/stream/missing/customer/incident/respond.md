...
**Path:** `eventualities/cross-product-actors/stream/missing/customer/incident/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **stream** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor commercial-layer customer or prospect.
