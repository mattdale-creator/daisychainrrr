# stream · silent-tombstone · attacker · release · test

**Path:** `eventualities/cross-product-actors/stream/silent-tombstone/attacker/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **stream** · missing bone without public tombstone · phase at seal/publish time · actor external or insider adversary.
