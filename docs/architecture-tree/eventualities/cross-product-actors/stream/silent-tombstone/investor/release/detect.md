# stream · silent-tombstone · investor · release · detect

**Path:** `eventualities/cross-product-actors/stream/silent-tombstone/investor/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **stream** · missing bone without public tombstone · phase at seal/publish time · actor funder or prospective capital.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product-actors/stream/silent-tombstone/investor/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
