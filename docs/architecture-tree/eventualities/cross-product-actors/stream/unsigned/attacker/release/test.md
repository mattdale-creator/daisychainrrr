# stream · unsigned · attacker · release · test

**Path:** `eventualities/cross-product-actors/stream/unsigned/attacker/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **stream** · release or index lacks required signature or seal · phase at seal/publish time · actor external or insider adversary.
