# boundary · missing · customer · incident

**Path:** `eventualities/cross-product-actors/boundary/missing/customer/incident/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **free core vs commercial boundary** is compromised by: **required artefact is absent when a public claim or release depends on it**.  
Lifecycle phase: **during or after a known incident**.  
Primary actor context: **commercial-layer customer or prospect**.

## Why it matters
Open weights or polished demos without verifiable free core vs commercial boundary are soft tissue.  
This path exists so the failure mode cannot hide in tribal knowledge.

## Where the bone lives
| Item | Location |
|------|----------|
| Artefacts | `commercial/BOUNDARY.md` |
| Domain / policy | Domain 8 |
| Verify | `isolation runbook` |
| Register on failure | registers/decisions/ + commercial/ |
...
1. **Stop the soft tissue:** pause any public claim that depends on healthy free core vs commercial boundary.
...
- BOUNDARY: commercial features cannot require opacity of free core vs commercial boundary if it is free-core.
