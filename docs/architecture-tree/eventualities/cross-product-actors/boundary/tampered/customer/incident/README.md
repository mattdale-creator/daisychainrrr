# boundary · tampered · customer · incident

**Path:** `eventualities/cross-product-actors/boundary/tampered/customer/incident/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **free core vs commercial boundary** is compromised by: **content no longer matches published hash / expected state**.  
