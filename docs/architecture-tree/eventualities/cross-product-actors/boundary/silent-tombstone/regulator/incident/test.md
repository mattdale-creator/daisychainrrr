# boundary · silent-tombstone · regulator · incident · test

**Path:** `eventualities/cross-product-actors/boundary/silent-tombstone/regulator/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **boundary** · missing bone without public tombstone · phase during or after a known incident · actor regulator or auditor.
...
1. Assume **missing bone without public tombstone** occurs in phase **during or after a known incident** with actor **regulator or auditor**.
