# boundary · silent-tombstone · attacker · release · test

**Path:** `eventualities/cross-product-actors/boundary/silent-tombstone/attacker/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **boundary** · missing bone without public tombstone · phase at seal/publish time · actor external or insider adversary.
...
1. Assume **missing bone without public tombstone** occurs in phase **at seal/publish time** with actor **external or insider adversary**.
