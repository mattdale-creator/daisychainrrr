# ttlink · missing · investor · release · test

**Path:** `eventualities/cross-product-actors/ttlink/missing/investor/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · required artefact is absent when a public claim or release depends on it · phase at seal/publish time · actor funder or prospective capital.
