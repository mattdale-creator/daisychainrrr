# ttlink · missing · attacker · incident · test

**Path:** `eventualities/cross-product-actors/ttlink/missing/attacker/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor external or insider adversary.
