# ttlink · silent-tombstone · regulator · release · test

**Path:** `eventualities/cross-product-actors/ttlink/silent-tombstone/regulator/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · missing bone without public tombstone · phase at seal/publish time · actor regulator or auditor.
