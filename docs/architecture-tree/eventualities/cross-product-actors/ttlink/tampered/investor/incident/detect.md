# ttlink · tampered · investor · incident · detect

**Path:** `eventualities/cross-product-actors/ttlink/tampered/investor/incident/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **ttlink** · content no longer matches published hash / expected state · phase during or after a known incident · actor funder or prospective capital.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product-actors/ttlink/tampered/investor/incident/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
