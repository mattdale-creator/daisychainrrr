# governance · missing · attacker · incident · prevent

**Path:** `eventualities/cross-product-actors/governance/missing/attacker/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **governance** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor external or insider adversary.
