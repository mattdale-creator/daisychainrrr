# governance · missing · founder · release · test

**Path:** `eventualities/cross-product-actors/governance/missing/founder/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · required artefact is absent when a public claim or release depends on it · phase at seal/publish time · actor project lead / founder.
