# governance · unsigned · customer · release · test

**Path:** `eventualities/cross-product-actors/governance/unsigned/customer/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · release or index lacks required signature or seal · phase at seal/publish time · actor commercial-layer customer or prospect.
...
1. Assume **release or index lacks required signature or seal** occurs in phase **at seal/publish time** with actor **commercial-layer customer or prospect**.
