...
**Path:** `eventualities/cross-product-actors/governance/unsigned/founder/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · release or index lacks required signature or seal · phase during or after a known incident · actor project lead / founder.
