# governance · silent-tombstone · regulator · release · test

**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/regulator/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · missing bone without public tombstone · phase at seal/publish time · actor regulator or auditor.
...
1. Assume **missing bone without public tombstone** occurs in phase **at seal/publish time** with actor **regulator or auditor**.
