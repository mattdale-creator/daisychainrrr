...
**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/investor/release/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **governance** · missing bone without public tombstone · phase at seal/publish time · actor funder or prospective capital.
