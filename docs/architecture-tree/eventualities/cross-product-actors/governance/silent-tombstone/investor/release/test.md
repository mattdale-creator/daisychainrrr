# governance · silent-tombstone · investor · release · test

**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/investor/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · missing bone without public tombstone · phase at seal/publish time · actor funder or prospective capital.
...
1. Assume **missing bone without public tombstone** occurs in phase **at seal/publish time** with actor **funder or prospective capital**.
