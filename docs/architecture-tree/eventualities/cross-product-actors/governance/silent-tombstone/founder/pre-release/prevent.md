# governance · silent-tombstone · founder · pre-release · prevent

**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/founder/pre-release/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **governance** · missing bone without public tombstone · phase before public release or claim · actor project lead / founder.
