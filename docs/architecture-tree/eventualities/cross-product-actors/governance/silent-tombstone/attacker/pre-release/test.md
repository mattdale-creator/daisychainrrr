# governance · silent-tombstone · attacker · pre-release · test

**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/attacker/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · missing bone without public tombstone · phase before public release or claim · actor external or insider adversary.
...
1. Assume **missing bone without public tombstone** occurs in phase **before public release or claim** with actor **external or insider adversary**.
