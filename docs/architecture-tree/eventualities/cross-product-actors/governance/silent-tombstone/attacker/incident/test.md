# governance · silent-tombstone · attacker · incident · test

**Path:** `eventualities/cross-product-actors/governance/silent-tombstone/attacker/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **governance** · missing bone without public tombstone · phase during or after a known incident · actor external or insider adversary.
...
1. Assume **missing bone without public tombstone** occurs in phase **during or after a known incident** with actor **external or insider adversary**.
