# governance · tampered · customer · incident

**Path:** `eventualities/cross-product-actors/governance/tampered/customer/incident/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **org decision-making** is compromised by: **content no longer matches published hash / expected state**.  
