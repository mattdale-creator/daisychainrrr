# weights · unsigned · acquisition · detect

**Path:** `eventualities/cross-product/weights/unsigned/acquisition/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **weights** · release or index lacks required signature or seal · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/weights/unsigned/acquisition/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
