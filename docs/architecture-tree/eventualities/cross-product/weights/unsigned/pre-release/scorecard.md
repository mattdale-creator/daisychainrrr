# weights · unsigned · pre-release · scorecard

**Path:** `eventualities/cross-product/weights/unsigned/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **weights** · release or index lacks required signature or seal · phase before public release or claim · actor project lead / founder.
