# weights · tombstoned-silent · incident · scorecard

**Path:** `eventualities/cross-product/weights/tombstoned-silent/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **weights** · gap exists without a public tombstone / honest disclosure · phase during or after a known incident · actor project lead / founder.
