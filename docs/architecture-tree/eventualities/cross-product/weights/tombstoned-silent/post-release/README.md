...
**Path:** `cross-product/weights/tombstoned-silent/post-release`

## What goes wrong
The **weights** layer is **tombstoned-silent** during **post-release**.
...
## Free core impact
If `weights` is part of free public core, Domain 5/8 apply. Scorecard tombstone required if public claim relies on it.
