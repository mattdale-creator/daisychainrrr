# weights · stale · acquisition

**Path:** `eventualities/cross-product/weights/stale/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **model weights / checkpoints** is compromised by: **artefact exists but is outdated relative to current release**.  
