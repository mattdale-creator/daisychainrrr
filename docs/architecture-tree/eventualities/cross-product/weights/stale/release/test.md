# weights · stale · release · test

**Path:** `eventualities/cross-product/weights/stale/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · artefact exists but is outdated relative to current release · phase at seal/publish time · actor project lead / founder.
