# weights · undocumented · pre-release · scorecard

**Path:** `eventualities/cross-product/weights/undocumented/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **weights** · artefact exists without public procedure, card, or scorecard row · phase before public release or claim · actor project lead / founder.
