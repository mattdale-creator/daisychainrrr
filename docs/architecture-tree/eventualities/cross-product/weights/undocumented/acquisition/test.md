# weights · undocumented · acquisition · test

**Path:** `eventualities/cross-product/weights/undocumented/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · artefact exists without public procedure, card, or scorecard row · phase under change-of-control or acquisition pressure · actor project lead / founder.
