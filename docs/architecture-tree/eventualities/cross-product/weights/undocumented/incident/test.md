# weights · undocumented · incident · test

**Path:** `eventualities/cross-product/weights/undocumented/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · artefact exists without public procedure, card, or scorecard row · phase during or after a known incident · actor project lead / founder.
