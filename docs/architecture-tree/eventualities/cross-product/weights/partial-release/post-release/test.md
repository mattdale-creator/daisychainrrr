# weights · partial-release · post-release · test

**Path:** `eventualities/cross-product/weights/partial-release/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · only a subset of promised bone was shipped without disclosure · phase after public release · actor project lead / founder.
