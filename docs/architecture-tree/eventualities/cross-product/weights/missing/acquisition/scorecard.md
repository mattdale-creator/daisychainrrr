# weights · missing · acquisition · scorecard

**Path:** `eventualities/cross-product/weights/missing/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **weights** · required artefact is absent when a public claim or release depends on it · phase under change-of-control or acquisition pressure · actor project lead / founder.
