# weights · scale-overclaim · acquisition

**Path:** `eventualities/cross-product/weights/scale-overclaim/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **model weights / checkpoints** is compromised by: **capability or corpus scale is overstated relative to artefacts**.  
