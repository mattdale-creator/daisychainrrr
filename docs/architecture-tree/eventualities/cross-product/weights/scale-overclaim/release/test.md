# weights · scale-overclaim · release · test

**Path:** `eventualities/cross-product/weights/scale-overclaim/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **weights** · capability or corpus scale is overstated relative to artefacts · phase at seal/publish time · actor project lead / founder.
