# weights · private-only · acquisition

**Path:** `eventualities/cross-product/weights/private-only/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **model weights / checkpoints** is compromised by: **material that should be free-core is held private without BOUNDARY justification**.  
