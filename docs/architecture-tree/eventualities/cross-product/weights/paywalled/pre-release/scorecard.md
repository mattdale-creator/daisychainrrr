# weights · paywalled · pre-release · scorecard

**Path:** `eventualities/cross-product/weights/paywalled/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **weights** · verification path is gated behind payment or private access · phase before public release or claim · actor project lead / founder.
