# metrics · stale · acquisition · scorecard

**Path:** `eventualities/cross-product/metrics/stale/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · artefact exists but is outdated relative to current release · phase under change-of-control or acquisition pressure · actor project lead / founder.
