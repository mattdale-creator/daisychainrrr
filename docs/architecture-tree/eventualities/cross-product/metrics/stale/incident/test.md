# metrics · stale · incident · test

**Path:** `eventualities/cross-product/metrics/stale/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **metrics** · artefact exists but is outdated relative to current release · phase during or after a known incident · actor project lead / founder.
