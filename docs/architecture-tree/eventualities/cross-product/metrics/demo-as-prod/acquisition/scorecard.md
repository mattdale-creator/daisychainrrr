# metrics · demo-as-prod · acquisition · scorecard

**Path:** `eventualities/cross-product/metrics/demo-as-prod/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · toy/demo scale is presented as production or frontier scale · phase under change-of-control or acquisition pressure · actor project lead / founder.
