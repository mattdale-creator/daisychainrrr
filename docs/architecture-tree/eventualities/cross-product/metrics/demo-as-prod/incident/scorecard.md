# metrics · demo-as-prod · incident · scorecard

**Path:** `eventualities/cross-product/metrics/demo-as-prod/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · toy/demo scale is presented as production or frontier scale · phase during or after a known incident · actor project lead / founder.
