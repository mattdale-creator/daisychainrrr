...
**Path:** `cross-product/metrics/tombstoned-silent/post-release`

## What goes wrong
The **metrics** layer is **tombstoned-silent** during **post-release**.
...
## Free core impact
If `metrics` is part of free public core, Domain 5/8 apply. Scorecard tombstone required if public claim relies on it.
