# metrics · tombstoned-silent · pre-release · scorecard

**Path:** `eventualities/cross-product/metrics/tombstoned-silent/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · gap exists without a public tombstone / honest disclosure · phase before public release or claim · actor project lead / founder.
