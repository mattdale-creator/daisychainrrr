# metrics · unsigned · acquisition

**Path:** `eventualities/cross-product/metrics/unsigned/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **training metrics / logs** is compromised by: **release or index lacks required signature or seal**.  
