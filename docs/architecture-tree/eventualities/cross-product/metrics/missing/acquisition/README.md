# metrics · missing · acquisition

**Path:** `eventualities/cross-product/metrics/missing/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **training metrics / logs** is compromised by: **required artefact is absent when a public claim or release depends on it**.  
