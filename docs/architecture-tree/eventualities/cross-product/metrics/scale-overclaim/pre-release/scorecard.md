# metrics · scale-overclaim · pre-release · scorecard

**Path:** `eventualities/cross-product/metrics/scale-overclaim/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · capability or corpus scale is overstated relative to artefacts · phase before public release or claim · actor project lead / founder.
