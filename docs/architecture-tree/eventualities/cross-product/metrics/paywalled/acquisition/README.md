# metrics · paywalled · acquisition

**Path:** `eventualities/cross-product/metrics/paywalled/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **training metrics / logs** is compromised by: **verification path is gated behind payment or private access**.  
