# metrics · paywalled · post-release · scorecard

**Path:** `eventualities/cross-product/metrics/paywalled/post-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **metrics** · verification path is gated behind payment or private access · phase after public release · actor project lead / founder.
