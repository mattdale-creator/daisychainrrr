...
**Path:** `cross-product/eval/tombstoned-silent/post-release`

## What goes wrong
The **eval** layer is **tombstoned-silent** during **post-release**.
...
## Free core impact
If `eval` is part of free public core, Domain 5/8 apply. Scorecard tombstone required if public claim relies on it.
