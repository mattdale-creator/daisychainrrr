# eval · tampered · acquisition

**Path:** `eventualities/cross-product/eval/tampered/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **evaluation artefacts** is compromised by: **content no longer matches published hash / expected state**.  
