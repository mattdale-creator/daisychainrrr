# eval · undocumented · incident · prevent

**Path:** `eventualities/cross-product/eval/undocumented/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **eval** · artefact exists without public procedure, card, or scorecard row · phase during or after a known incident · actor project lead / founder.
