# eval · scale-overclaim · acquisition · prevent

**Path:** `eventualities/cross-product/eval/scale-overclaim/acquisition/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **eval** · capability or corpus scale is overstated relative to artefacts · phase under change-of-control or acquisition pressure · actor project lead / founder.
