# eval · scale-overclaim · release · scorecard

**Path:** `eventualities/cross-product/eval/scale-overclaim/release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **eval** · capability or corpus scale is overstated relative to artefacts · phase at seal/publish time · actor project lead / founder.
