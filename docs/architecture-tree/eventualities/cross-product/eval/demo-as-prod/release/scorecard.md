# eval · demo-as-prod · release · scorecard

**Path:** `eventualities/cross-product/eval/demo-as-prod/release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **eval** · toy/demo scale is presented as production or frontier scale · phase at seal/publish time · actor project lead / founder.
