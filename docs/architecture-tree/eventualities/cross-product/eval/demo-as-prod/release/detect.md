# eval · demo-as-prod · release · detect

**Path:** `eventualities/cross-product/eval/demo-as-prod/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **eval** · toy/demo scale is presented as production or frontier scale · phase at seal/publish time · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/eval/demo-as-prod/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
