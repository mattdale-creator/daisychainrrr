# eval · paywalled · acquisition

**Path:** `eventualities/cross-product/eval/paywalled/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **evaluation artefacts** is compromised by: **verification path is gated behind payment or private access**.  
