# eval · private-only · incident · test

**Path:** `eventualities/cross-product/eval/private-only/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **eval** · material that should be free-core is held private without BOUNDARY justification · phase during or after a known incident · actor project lead / founder.
