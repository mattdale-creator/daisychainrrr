# eval · unsigned · incident · detect

**Path:** `eventualities/cross-product/eval/unsigned/incident/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **eval** · release or index lacks required signature or seal · phase during or after a known incident · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/eval/unsigned/incident/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
