# eval · unsigned · post-release · test

**Path:** `eventualities/cross-product/eval/unsigned/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **eval** · release or index lacks required signature or seal · phase after public release · actor project lead / founder.
