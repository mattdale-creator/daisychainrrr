# manifest · undocumented · incident · respond

**Path:** `eventualities/cross-product/manifest/undocumented/incident/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **manifest** · artefact exists without public procedure, card, or scorecard row · phase during or after a known incident · actor project lead / founder.
