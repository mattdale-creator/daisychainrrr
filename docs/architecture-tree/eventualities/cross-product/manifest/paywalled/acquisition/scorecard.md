# manifest · paywalled · acquisition · scorecard

**Path:** `eventualities/cross-product/manifest/paywalled/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **manifest** · verification path is gated behind payment or private access · phase under change-of-control or acquisition pressure · actor project lead / founder.
