# manifest · paywalled · acquisition · test

**Path:** `eventualities/cross-product/manifest/paywalled/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · verification path is gated behind payment or private access · phase under change-of-control or acquisition pressure · actor project lead / founder.
