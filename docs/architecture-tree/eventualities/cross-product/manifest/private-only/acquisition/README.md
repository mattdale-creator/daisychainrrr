# manifest · private-only · acquisition

**Path:** `eventualities/cross-product/manifest/private-only/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **cryptographic Merkle manifests** is compromised by: **material that should be free-core is held private without BOUNDARY justification**.  
