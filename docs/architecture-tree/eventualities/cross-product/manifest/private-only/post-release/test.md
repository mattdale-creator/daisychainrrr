# manifest · private-only · post-release · test

**Path:** `eventualities/cross-product/manifest/private-only/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **manifest** · material that should be free-core is held private without BOUNDARY justification · phase after public release · actor project lead / founder.
