# manifest · wrong-hash · acquisition

**Path:** `eventualities/cross-product/manifest/wrong-hash/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **cryptographic Merkle manifests** is compromised by: **published sha256/Merkle root does not match re-hash of files**.  
