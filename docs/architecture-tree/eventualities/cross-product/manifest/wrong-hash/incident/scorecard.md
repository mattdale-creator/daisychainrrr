# manifest · wrong-hash · incident · scorecard

**Path:** `eventualities/cross-product/manifest/wrong-hash/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **manifest** · published sha256/Merkle root does not match re-hash of files · phase during or after a known incident · actor project lead / founder.
