# manifest · tampered · incident · prevent

**Path:** `eventualities/cross-product/manifest/tampered/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **manifest** · content no longer matches published hash / expected state · phase during or after a known incident · actor project lead / founder.
