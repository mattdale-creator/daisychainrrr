# scorecard · tampered · release · test

**Path:** `eventualities/cross-product/scorecard/tampered/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · content no longer matches published hash / expected state · phase at seal/publish time · actor project lead / founder.
...
1. Assume **content no longer matches published hash / expected state** occurs in phase **at seal/publish time** with actor **project lead / founder**.
