# scorecard · unsigned · incident · scorecard

**Path:** `eventualities/cross-product/scorecard/unsigned/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **scorecard** · release or index lacks required signature or seal · phase during or after a known incident · actor project lead / founder.
