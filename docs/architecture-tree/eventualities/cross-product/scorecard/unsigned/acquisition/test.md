# scorecard · unsigned · acquisition · test

**Path:** `eventualities/cross-product/scorecard/unsigned/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · release or index lacks required signature or seal · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **release or index lacks required signature or seal** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
