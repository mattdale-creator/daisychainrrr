# scorecard · unsigned · acquisition · prevent

**Path:** `eventualities/cross-product/scorecard/unsigned/acquisition/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **scorecard** · release or index lacks required signature or seal · phase under change-of-control or acquisition pressure · actor project lead / founder.
