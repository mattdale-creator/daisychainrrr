# scorecard · unsigned · release · test

**Path:** `eventualities/cross-product/scorecard/unsigned/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · release or index lacks required signature or seal · phase at seal/publish time · actor project lead / founder.
...
1. Assume **release or index lacks required signature or seal** occurs in phase **at seal/publish time** with actor **project lead / founder**.
