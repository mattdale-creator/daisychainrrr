# scorecard · wrong-hash · post-release · scorecard

**Path:** `eventualities/cross-product/scorecard/wrong-hash/post-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **scorecard** · published sha256/Merkle root does not match re-hash of files · phase after public release · actor project lead / founder.
