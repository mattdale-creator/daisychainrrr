# scorecard · wrong-hash · release · test

**Path:** `eventualities/cross-product/scorecard/wrong-hash/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · published sha256/Merkle root does not match re-hash of files · phase at seal/publish time · actor project lead / founder.
...
1. Assume **published sha256/Merkle root does not match re-hash of files** occurs in phase **at seal/publish time** with actor **project lead / founder**.
