# scorecard · wrong-hash · acquisition · scorecard

**Path:** `eventualities/cross-product/scorecard/wrong-hash/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **scorecard** · published sha256/Merkle root does not match re-hash of files · phase under change-of-control or acquisition pressure · actor project lead / founder.
