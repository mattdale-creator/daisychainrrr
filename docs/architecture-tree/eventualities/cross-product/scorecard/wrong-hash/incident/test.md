# scorecard · wrong-hash · incident · test

**Path:** `eventualities/cross-product/scorecard/wrong-hash/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · published sha256/Merkle root does not match re-hash of files · phase during or after a known incident · actor project lead / founder.
...
1. Assume **published sha256/Merkle root does not match re-hash of files** occurs in phase **during or after a known incident** with actor **project lead / founder**.
