# scorecard · wrong-hash · incident · prevent

**Path:** `eventualities/cross-product/scorecard/wrong-hash/incident/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **scorecard** · published sha256/Merkle root does not match re-hash of files · phase during or after a known incident · actor project lead / founder.
