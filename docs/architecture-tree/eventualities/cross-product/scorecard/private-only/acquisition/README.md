# scorecard · private-only · acquisition

**Path:** `eventualities/cross-product/scorecard/private-only/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **transparency scorecard** is compromised by: **material that should be free-core is held private without BOUNDARY justification**.  
Lifecycle phase: **under change-of-control or acquisition pressure**.  
Primary actor context: **any actor (founder default)**.

## Why it matters
Open weights or polished demos without verifiable transparency scorecard are soft tissue.  
This path exists so the failure mode cannot hide in tribal knowledge.

## Where the bone lives
| Item | Location |
|------|----------|
| Artefacts | `models/*/cards/TRANSPARENCY_SCORECARD.md` |
| Domain / policy | all domains 1–10 |
| Verify | `MASTER_DOMAIN_SCORECARD` |
...
1. **Stop the soft tissue:** pause any public claim that depends on healthy transparency scorecard.
...
- BOUNDARY: commercial features cannot require opacity of transparency scorecard if it is free-core.
