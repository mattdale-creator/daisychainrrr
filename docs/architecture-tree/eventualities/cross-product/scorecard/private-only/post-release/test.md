# scorecard · private-only · post-release · test

**Path:** `eventualities/cross-product/scorecard/private-only/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · material that should be free-core is held private without BOUNDARY justification · phase after public release · actor project lead / founder.
...
1. Assume **material that should be free-core is held private without BOUNDARY justification** occurs in phase **after public release** with actor **project lead / founder**.
