# scorecard · private-only · release · test

**Path:** `eventualities/cross-product/scorecard/private-only/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · material that should be free-core is held private without BOUNDARY justification · phase at seal/publish time · actor project lead / founder.
...
1. Assume **material that should be free-core is held private without BOUNDARY justification** occurs in phase **at seal/publish time** with actor **project lead / founder**.
