# scorecard · undocumented · acquisition

**Path:** `eventualities/cross-product/scorecard/undocumented/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **transparency scorecard** is compromised by: **artefact exists without public procedure, card, or scorecard row**.  
