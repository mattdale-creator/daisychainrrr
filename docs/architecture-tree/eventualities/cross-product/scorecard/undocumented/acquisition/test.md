# scorecard · undocumented · acquisition · test

**Path:** `eventualities/cross-product/scorecard/undocumented/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · artefact exists without public procedure, card, or scorecard row · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **artefact exists without public procedure, card, or scorecard row** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
