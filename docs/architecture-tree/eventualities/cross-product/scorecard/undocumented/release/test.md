# scorecard · undocumented · release · test

**Path:** `eventualities/cross-product/scorecard/undocumented/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · artefact exists without public procedure, card, or scorecard row · phase at seal/publish time · actor project lead / founder.
...
1. Assume **artefact exists without public procedure, card, or scorecard row** occurs in phase **at seal/publish time** with actor **project lead / founder**.
