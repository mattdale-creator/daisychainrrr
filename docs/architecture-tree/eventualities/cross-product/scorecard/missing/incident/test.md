# scorecard · missing · incident · test

**Path:** `eventualities/cross-product/scorecard/missing/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor project lead / founder.
...
1. Assume **required artefact is absent when a public claim or release depends on it** occurs in phase **during or after a known incident** with actor **project lead / founder**.
