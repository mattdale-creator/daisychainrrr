# scorecard · tombstoned-silent · acquisition · test

**Path:** `eventualities/cross-product/scorecard/tombstoned-silent/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · gap exists without a public tombstone / honest disclosure · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **gap exists without a public tombstone / honest disclosure** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
