# scorecard · tombstoned-silent · incident · test

**Path:** `eventualities/cross-product/scorecard/tombstoned-silent/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · gap exists without a public tombstone / honest disclosure · phase during or after a known incident · actor project lead / founder.
...
1. Assume **gap exists without a public tombstone / honest disclosure** occurs in phase **during or after a known incident** with actor **project lead / founder**.
