# scorecard · tombstoned-silent · release · test

**Path:** `eventualities/cross-product/scorecard/tombstoned-silent/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · gap exists without a public tombstone / honest disclosure · phase at seal/publish time · actor project lead / founder.
...
1. Assume **gap exists without a public tombstone / honest disclosure** occurs in phase **at seal/publish time** with actor **project lead / founder**.
