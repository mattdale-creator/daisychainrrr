# scorecard · tombstoned-silent · pre-release · detect

**Path:** `eventualities/cross-product/scorecard/tombstoned-silent/pre-release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **scorecard** · gap exists without a public tombstone / honest disclosure · phase before public release or claim · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/scorecard/tombstoned-silent/pre-release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
