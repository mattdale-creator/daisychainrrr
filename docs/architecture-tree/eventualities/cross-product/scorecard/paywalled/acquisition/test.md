# scorecard · paywalled · acquisition · test

**Path:** `eventualities/cross-product/scorecard/paywalled/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · verification path is gated behind payment or private access · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **verification path is gated behind payment or private access** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
