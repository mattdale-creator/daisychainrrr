# scorecard · paywalled · pre-release · test

**Path:** `eventualities/cross-product/scorecard/paywalled/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · verification path is gated behind payment or private access · phase before public release or claim · actor project lead / founder.
...
1. Assume **verification path is gated behind payment or private access** occurs in phase **before public release or claim** with actor **project lead / founder**.
