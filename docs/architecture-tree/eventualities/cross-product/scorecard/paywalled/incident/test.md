# scorecard · paywalled · incident · test

**Path:** `eventualities/cross-product/scorecard/paywalled/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · verification path is gated behind payment or private access · phase during or after a known incident · actor project lead / founder.
...
1. Assume **verification path is gated behind payment or private access** occurs in phase **during or after a known incident** with actor **project lead / founder**.
