# scorecard · partial-release · acquisition · test

**Path:** `eventualities/cross-product/scorecard/partial-release/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · only a subset of promised bone was shipped without disclosure · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **only a subset of promised bone was shipped without disclosure** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
