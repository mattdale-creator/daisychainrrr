# scorecard · partial-release · pre-release · test

**Path:** `eventualities/cross-product/scorecard/partial-release/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · only a subset of promised bone was shipped without disclosure · phase before public release or claim · actor project lead / founder.
...
1. Assume **only a subset of promised bone was shipped without disclosure** occurs in phase **before public release or claim** with actor **project lead / founder**.
