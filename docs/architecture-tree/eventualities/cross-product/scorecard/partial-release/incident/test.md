# scorecard · partial-release · incident · test

**Path:** `eventualities/cross-product/scorecard/partial-release/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · only a subset of promised bone was shipped without disclosure · phase during or after a known incident · actor project lead / founder.
...
1. Assume **only a subset of promised bone was shipped without disclosure** occurs in phase **during or after a known incident** with actor **project lead / founder**.
