# scorecard · partial-release · release · scorecard

**Path:** `eventualities/cross-product/scorecard/partial-release/release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **scorecard** · only a subset of promised bone was shipped without disclosure · phase at seal/publish time · actor project lead / founder.
