# scorecard · scale-overclaim · acquisition · scorecard

**Path:** `eventualities/cross-product/scorecard/scale-overclaim/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **scorecard** · capability or corpus scale is overstated relative to artefacts · phase under change-of-control or acquisition pressure · actor project lead / founder.
