# scorecard · scale-overclaim · post-release · test

**Path:** `eventualities/cross-product/scorecard/scale-overclaim/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · capability or corpus scale is overstated relative to artefacts · phase after public release · actor project lead / founder.
...
1. Assume **capability or corpus scale is overstated relative to artefacts** occurs in phase **after public release** with actor **project lead / founder**.
