# scorecard · scale-overclaim · pre-release · test

**Path:** `eventualities/cross-product/scorecard/scale-overclaim/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · capability or corpus scale is overstated relative to artefacts · phase before public release or claim · actor project lead / founder.
...
1. Assume **capability or corpus scale is overstated relative to artefacts** occurs in phase **before public release or claim** with actor **project lead / founder**.
