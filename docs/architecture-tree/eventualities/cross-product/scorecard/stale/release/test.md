# scorecard · stale · release · test

**Path:** `eventualities/cross-product/scorecard/stale/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · artefact exists but is outdated relative to current release · phase at seal/publish time · actor project lead / founder.
...
1. Assume **artefact exists but is outdated relative to current release** occurs in phase **at seal/publish time** with actor **project lead / founder**.
