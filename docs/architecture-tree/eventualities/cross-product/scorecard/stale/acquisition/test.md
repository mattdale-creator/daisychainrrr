# scorecard · stale · acquisition · test

**Path:** `eventualities/cross-product/scorecard/stale/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **scorecard** · artefact exists but is outdated relative to current release · phase under change-of-control or acquisition pressure · actor project lead / founder.
...
1. Assume **artefact exists but is outdated relative to current release** occurs in phase **under change-of-control or acquisition pressure** with actor **project lead / founder**.
