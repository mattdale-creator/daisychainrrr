# scorecard · demo-as-prod · acquisition

**Path:** `eventualities/cross-product/scorecard/demo-as-prod/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **transparency scorecard** is compromised by: **toy/demo scale is presented as production or frontier scale**.  
