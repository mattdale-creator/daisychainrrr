# ttlink · partial-release · release · detect

**Path:** `eventualities/cross-product/ttlink/partial-release/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **ttlink** · only a subset of promised bone was shipped without disclosure · phase at seal/publish time · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/ttlink/partial-release/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
