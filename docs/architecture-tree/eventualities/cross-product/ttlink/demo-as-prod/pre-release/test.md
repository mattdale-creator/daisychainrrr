# ttlink · demo-as-prod · pre-release · test

**Path:** `eventualities/cross-product/ttlink/demo-as-prod/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · toy/demo scale is presented as production or frontier scale · phase before public release or claim · actor project lead / founder.
