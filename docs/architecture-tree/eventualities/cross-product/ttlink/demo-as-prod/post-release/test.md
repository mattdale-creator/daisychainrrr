# ttlink · demo-as-prod · post-release · test

**Path:** `eventualities/cross-product/ttlink/demo-as-prod/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · toy/demo scale is presented as production or frontier scale · phase after public release · actor project lead / founder.
