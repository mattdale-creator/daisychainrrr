# ttlink · demo-as-prod · incident · detect

**Path:** `eventualities/cross-product/ttlink/demo-as-prod/incident/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **ttlink** · toy/demo scale is presented as production or frontier scale · phase during or after a known incident · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/ttlink/demo-as-prod/incident/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
