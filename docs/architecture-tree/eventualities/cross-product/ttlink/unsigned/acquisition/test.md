# ttlink · unsigned · acquisition · test

**Path:** `eventualities/cross-product/ttlink/unsigned/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · release or index lacks required signature or seal · phase under change-of-control or acquisition pressure · actor project lead / founder.
