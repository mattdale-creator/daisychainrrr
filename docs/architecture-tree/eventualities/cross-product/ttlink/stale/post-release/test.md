# ttlink · stale · post-release · test

**Path:** `eventualities/cross-product/ttlink/stale/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · artefact exists but is outdated relative to current release · phase after public release · actor project lead / founder.
