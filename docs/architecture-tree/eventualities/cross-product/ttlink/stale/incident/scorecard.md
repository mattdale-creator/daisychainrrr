# ttlink · stale · incident · scorecard

**Path:** `eventualities/cross-product/ttlink/stale/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **ttlink** · artefact exists but is outdated relative to current release · phase during or after a known incident · actor project lead / founder.
