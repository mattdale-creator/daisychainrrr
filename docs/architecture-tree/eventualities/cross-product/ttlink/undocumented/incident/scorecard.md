# ttlink · undocumented · incident · scorecard

**Path:** `eventualities/cross-product/ttlink/undocumented/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **ttlink** · artefact exists without public procedure, card, or scorecard row · phase during or after a known incident · actor project lead / founder.
