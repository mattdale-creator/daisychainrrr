# ttlink · undocumented · release · test

**Path:** `eventualities/cross-product/ttlink/undocumented/release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **ttlink** · artefact exists without public procedure, card, or scorecard row · phase at seal/publish time · actor project lead / founder.
