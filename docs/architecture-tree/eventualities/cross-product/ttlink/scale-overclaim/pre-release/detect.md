# ttlink · scale-overclaim · pre-release · detect

**Path:** `eventualities/cross-product/ttlink/scale-overclaim/pre-release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **ttlink** · capability or corpus scale is overstated relative to artefacts · phase before public release or claim · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/ttlink/scale-overclaim/pre-release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
