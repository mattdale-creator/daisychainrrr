# ttlink · tombstoned-silent · release · scorecard

**Path:** `eventualities/cross-product/ttlink/tombstoned-silent/release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **ttlink** · gap exists without a public tombstone / honest disclosure · phase at seal/publish time · actor project lead / founder.
