# ttlink · missing · acquisition · prevent

**Path:** `eventualities/cross-product/ttlink/missing/acquisition/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **ttlink** · required artefact is absent when a public claim or release depends on it · phase under change-of-control or acquisition pressure · actor project lead / founder.
