# data · partial-release · acquisition

**Path:** `eventualities/cross-product/data/partial-release/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **training data / mixture** is compromised by: **only a subset of promised bone was shipped without disclosure**.  
