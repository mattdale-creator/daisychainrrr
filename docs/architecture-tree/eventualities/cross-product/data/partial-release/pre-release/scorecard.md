# data · partial-release · pre-release · scorecard

**Path:** `eventualities/cross-product/data/partial-release/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **data** · only a subset of promised bone was shipped without disclosure · phase before public release or claim · actor project lead / founder.
