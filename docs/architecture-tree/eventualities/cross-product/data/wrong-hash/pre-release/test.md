# data · wrong-hash · pre-release · test

**Path:** `eventualities/cross-product/data/wrong-hash/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **data** · published sha256/Merkle root does not match re-hash of files · phase before public release or claim · actor project lead / founder.
