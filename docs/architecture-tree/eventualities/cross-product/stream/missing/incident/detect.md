# stream · missing · incident · detect

**Path:** `eventualities/cross-product/stream/missing/incident/detect.md`  
**Updated:** 2026-08-08  
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/stream/missing/incident/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
