# stream · stale · post-release · scorecard

**Path:** `eventualities/cross-product/stream/stale/post-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **stream** · artefact exists but is outdated relative to current release · phase after public release · actor project lead / founder.
