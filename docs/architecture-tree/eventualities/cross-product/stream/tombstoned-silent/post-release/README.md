...
**Path:** `cross-product/stream/tombstoned-silent/post-release`

## What goes wrong
The **stream** layer is **tombstoned-silent** during **post-release**.
...
## Free core impact
If `stream` is part of free public core, Domain 5/8 apply. Scorecard tombstone required if public claim relies on it.
