# checkpoints · wrong-hash · acquisition · test

**Path:** `eventualities/cross-product/checkpoints/wrong-hash/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · published sha256/Merkle root does not match re-hash of files · phase under change-of-control or acquisition pressure · actor project lead / founder.
