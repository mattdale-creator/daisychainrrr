# checkpoints · private-only · release · respond

**Path:** `eventualities/cross-product/checkpoints/private-only/release/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **checkpoints** · material that should be free-core is held private without BOUNDARY justification · phase at seal/publish time · actor project lead / founder.
