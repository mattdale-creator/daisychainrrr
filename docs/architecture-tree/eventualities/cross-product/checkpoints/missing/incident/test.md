# checkpoints · missing · incident · test

**Path:** `eventualities/cross-product/checkpoints/missing/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · required artefact is absent when a public claim or release depends on it · phase during or after a known incident · actor project lead / founder.
