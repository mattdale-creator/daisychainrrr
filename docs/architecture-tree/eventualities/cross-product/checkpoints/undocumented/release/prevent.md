# checkpoints · undocumented · release · prevent

**Path:** `eventualities/cross-product/checkpoints/undocumented/release/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: **checkpoints** · artefact exists without public procedure, card, or scorecard row · phase at seal/publish time · actor project lead / founder.
