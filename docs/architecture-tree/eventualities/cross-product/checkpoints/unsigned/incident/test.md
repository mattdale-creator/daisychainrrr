# checkpoints · unsigned · incident · test

**Path:** `eventualities/cross-product/checkpoints/unsigned/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · release or index lacks required signature or seal · phase during or after a known incident · actor project lead / founder.
