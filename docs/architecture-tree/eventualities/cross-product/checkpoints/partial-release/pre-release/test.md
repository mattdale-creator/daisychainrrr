# checkpoints · partial-release · pre-release · test

**Path:** `eventualities/cross-product/checkpoints/partial-release/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · only a subset of promised bone was shipped without disclosure · phase before public release or claim · actor project lead / founder.
