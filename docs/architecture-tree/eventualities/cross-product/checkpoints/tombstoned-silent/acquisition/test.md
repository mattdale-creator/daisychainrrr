# checkpoints · tombstoned-silent · acquisition · test

**Path:** `eventualities/cross-product/checkpoints/tombstoned-silent/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · gap exists without a public tombstone / honest disclosure · phase under change-of-control or acquisition pressure · actor project lead / founder.
