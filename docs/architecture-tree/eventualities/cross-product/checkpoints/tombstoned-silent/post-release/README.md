...
**Path:** `cross-product/checkpoints/tombstoned-silent/post-release`

## What goes wrong
The **checkpoints** layer is **tombstoned-silent** during **post-release**.
...
## Free core impact
If `checkpoints` is part of free public core, Domain 5/8 apply. Scorecard tombstone required if public claim relies on it.
