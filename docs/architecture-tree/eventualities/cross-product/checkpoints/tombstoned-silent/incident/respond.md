# checkpoints · tombstoned-silent · incident · respond

**Path:** `eventualities/cross-product/checkpoints/tombstoned-silent/incident/respond.md`  
**Updated:** 2026-08-08  
**Leaf type:** respond — exact steps after detection

## Purpose
Exact steps after detection for: **checkpoints** · gap exists without a public tombstone / honest disclosure · phase during or after a known incident · actor project lead / founder.
