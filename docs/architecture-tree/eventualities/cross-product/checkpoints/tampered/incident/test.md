# checkpoints · tampered · incident · test

**Path:** `eventualities/cross-product/checkpoints/tampered/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **checkpoints** · content no longer matches published hash / expected state · phase during or after a known incident · actor project lead / founder.
