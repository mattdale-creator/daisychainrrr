# code · tampered · pre-release · test

**Path:** `eventualities/cross-product/code/tampered/pre-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **code** · content no longer matches published hash / expected state · phase before public release or claim · actor project lead / founder.
