# code · tampered · acquisition

**Path:** `eventualities/cross-product/code/tampered/acquisition/README.md`  
**Updated:** 2026-08-08  
**Ethos:** down to the bone / free public core / product is the proof

## What this eventuality is
The **training / free_core code** is compromised by: **content no longer matches published hash / expected state**.  
