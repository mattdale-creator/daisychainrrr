# code · tampered · acquisition · scorecard

**Path:** `eventualities/cross-product/code/tampered/acquisition/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **code** · content no longer matches published hash / expected state · phase under change-of-control or acquisition pressure · actor project lead / founder.
