# code · paywalled · incident · test

**Path:** `eventualities/cross-product/code/paywalled/incident/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **code** · verification path is gated behind payment or private access · phase during or after a known incident · actor project lead / founder.
