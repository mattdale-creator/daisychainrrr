# code · missing · post-release · scorecard

**Path:** `eventualities/cross-product/code/missing/post-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **code** · required artefact is absent when a public claim or release depends on it · phase after public release · actor project lead / founder.
