# code · tombstoned-silent · release · detect

**Path:** `eventualities/cross-product/code/tombstoned-silent/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **code** · gap exists without a public tombstone / honest disclosure · phase at seal/publish time · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/code/tombstoned-silent/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
