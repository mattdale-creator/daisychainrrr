# code · tombstoned-silent · pre-release · scorecard

**Path:** `eventualities/cross-product/code/tombstoned-silent/pre-release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **code** · gap exists without a public tombstone / honest disclosure · phase before public release or claim · actor project lead / founder.
