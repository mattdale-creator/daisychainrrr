# code · wrong-hash · incident · scorecard

**Path:** `eventualities/cross-product/code/wrong-hash/incident/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **code** · published sha256/Merkle root does not match re-hash of files · phase during or after a known incident · actor project lead / founder.
