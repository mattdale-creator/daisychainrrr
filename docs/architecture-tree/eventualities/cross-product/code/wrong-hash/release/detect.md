# code · wrong-hash · release · detect

**Path:** `eventualities/cross-product/code/wrong-hash/release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **code** · published sha256/Merkle root does not match re-hash of files · phase at seal/publish time · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/code/wrong-hash/release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
