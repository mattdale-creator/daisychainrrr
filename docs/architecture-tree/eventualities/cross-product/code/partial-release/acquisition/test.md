# code · partial-release · acquisition · test

**Path:** `eventualities/cross-product/code/partial-release/acquisition/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **code** · only a subset of promised bone was shipped without disclosure · phase under change-of-control or acquisition pressure · actor project lead / founder.
