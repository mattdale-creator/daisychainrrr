# code · undocumented · release · scorecard

**Path:** `eventualities/cross-product/code/undocumented/release/scorecard.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard — how scorecards/tombstones must reflect this

## Purpose
How scorecards/tombstones must reflect this for: **code** · artefact exists without public procedure, card, or scorecard row · phase at seal/publish time · actor project lead / founder.
