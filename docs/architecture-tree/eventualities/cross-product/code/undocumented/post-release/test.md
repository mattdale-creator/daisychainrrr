# code · undocumented · post-release · test

**Path:** `eventualities/cross-product/code/undocumented/post-release/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: **code** · artefact exists without public procedure, card, or scorecard row · phase after public release · actor project lead / founder.
