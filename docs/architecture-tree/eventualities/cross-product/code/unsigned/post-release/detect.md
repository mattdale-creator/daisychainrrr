# code · unsigned · post-release · detect

**Path:** `eventualities/cross-product/code/unsigned/post-release/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **code** · release or index lacks required signature or seal · phase after public release · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `cross-product/code/unsigned/post-release/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
