# aesthetic-without-data → detect

**Full path:** `02-product/matrix-surface/aesthetic-without-data/detect`

## Purpose
Operational leaf for the `aesthetic-without-data` eventuality: **detect**.
