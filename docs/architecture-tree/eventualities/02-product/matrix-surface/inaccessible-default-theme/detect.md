# inaccessible-default-theme → detect

**Full path:** `02-product/matrix-surface/inaccessible-default-theme/detect`

## Purpose
Operational leaf for the `inaccessible-default-theme` eventuality: **detect**.
