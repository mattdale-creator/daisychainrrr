# inaccessible-default-theme → test-or-drill

**Full path:** `02-product/matrix-surface/inaccessible-default-theme/test-or-drill`

## Purpose
Operational leaf for the `inaccessible-default-theme` eventuality: **test-or-drill**.
