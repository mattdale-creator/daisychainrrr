# inaccessible-default-theme → tombstone-criteria

**Full path:** `02-product/matrix-surface/inaccessible-default-theme/tombstone-criteria`

## Purpose
Operational leaf for the `inaccessible-default-theme` eventuality: **tombstone-criteria**.
