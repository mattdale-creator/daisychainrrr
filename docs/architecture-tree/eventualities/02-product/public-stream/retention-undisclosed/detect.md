# retention-undisclosed → detect

**Full path:** `02-product/public-stream/retention-undisclosed/detect`

## Purpose
Operational leaf for the `retention-undisclosed` eventuality: **detect**.
