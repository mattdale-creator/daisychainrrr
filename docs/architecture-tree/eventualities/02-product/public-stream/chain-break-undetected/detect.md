# 02-product/public-stream/chain-break-undetected/detect.md · detect

**Path:** `eventualities/02-product/public-stream/chain-break-undetected/detect.md`  
**Updated:** 2026-08-08  
...
## Output of detection
Write a one-paragraph incident/note with: path `02-product/public-stream/chain-break-undetected/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
