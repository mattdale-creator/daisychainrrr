# chain-break-undetected → detect

**Full path:** `02-product/public-stream/chain-break-undetected/detect`

## Purpose
Operational leaf for the `chain-break-undetected` eventuality: **detect**.
