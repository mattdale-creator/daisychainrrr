# chain-break-undetected → tombstone-criteria

**Full path:** `02-product/public-stream/chain-break-undetected/tombstone-criteria`

## Purpose
Operational leaf for the `chain-break-undetected` eventuality: **tombstone-criteria**.
