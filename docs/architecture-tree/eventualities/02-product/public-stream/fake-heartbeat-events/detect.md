# fake-heartbeat-events → detect

**Full path:** `02-product/public-stream/fake-heartbeat-events/detect`

## Purpose
Operational leaf for the `fake-heartbeat-events` eventuality: **detect**.
