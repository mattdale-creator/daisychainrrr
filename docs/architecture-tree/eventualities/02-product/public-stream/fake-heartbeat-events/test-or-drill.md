# fake-heartbeat-events → test-or-drill

**Full path:** `02-product/public-stream/fake-heartbeat-events/test-or-drill`

## Purpose
Operational leaf for the `fake-heartbeat-events` eventuality: **test-or-drill**.
