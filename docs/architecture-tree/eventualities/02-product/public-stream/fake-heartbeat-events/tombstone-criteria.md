# fake-heartbeat-events → tombstone-criteria

**Full path:** `02-product/public-stream/fake-heartbeat-events/tombstone-criteria`

## Purpose
Operational leaf for the `fake-heartbeat-events` eventuality: **tombstone-criteria**.
