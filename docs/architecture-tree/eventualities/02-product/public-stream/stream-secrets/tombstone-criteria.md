# stream-secrets → tombstone-criteria

**Full path:** `02-product/public-stream/stream-secrets/tombstone-criteria`

## Purpose
Operational leaf for the `stream-secrets` eventuality: **tombstone-criteria**.
