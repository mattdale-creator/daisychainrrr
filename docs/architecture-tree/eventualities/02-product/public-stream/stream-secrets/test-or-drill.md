# stream-secrets → test-or-drill

**Full path:** `02-product/public-stream/stream-secrets/test-or-drill`

## Purpose
Operational leaf for the `stream-secrets` eventuality: **test-or-drill**.
