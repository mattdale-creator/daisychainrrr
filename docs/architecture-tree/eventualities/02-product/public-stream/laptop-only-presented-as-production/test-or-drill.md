# laptop-only-presented-as-production → test-or-drill

**Full path:** `02-product/public-stream/laptop-only-presented-as-production/test-or-drill`

## Purpose
Operational leaf for the `laptop-only-presented-as-production` eventuality: **test-or-drill**.
