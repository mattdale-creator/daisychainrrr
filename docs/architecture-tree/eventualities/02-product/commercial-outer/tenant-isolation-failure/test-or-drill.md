# tenant-isolation-failure → test-or-drill

**Full path:** `02-product/commercial-outer/tenant-isolation-failure/test-or-drill`

## Purpose
Operational leaf for the `tenant-isolation-failure` eventuality: **test-or-drill**.
