# tenant-isolation-failure → respond

**Full path:** `02-product/commercial-outer/tenant-isolation-failure/respond`

## Purpose
Operational leaf for the `tenant-isolation-failure` eventuality: **respond**.
