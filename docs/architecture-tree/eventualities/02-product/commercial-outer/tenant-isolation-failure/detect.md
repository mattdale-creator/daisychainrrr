# tenant-isolation-failure → detect

**Full path:** `02-product/commercial-outer/tenant-isolation-failure/detect`

## Purpose
Operational leaf for the `tenant-isolation-failure` eventuality: **detect**.
