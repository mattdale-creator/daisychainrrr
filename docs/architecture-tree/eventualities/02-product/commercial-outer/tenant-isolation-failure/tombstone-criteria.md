# tenant-isolation-failure → tombstone-criteria

**Full path:** `02-product/commercial-outer/tenant-isolation-failure/tombstone-criteria`

## Purpose
Operational leaf for the `tenant-isolation-failure` eventuality: **tombstone-criteria**.
