# enterprise-exclusive-weights → tombstone-criteria

**Full path:** `02-product/commercial-outer/enterprise-exclusive-weights/tombstone-criteria`

## Purpose
Operational leaf for the `enterprise-exclusive-weights` eventuality: **tombstone-criteria**.
