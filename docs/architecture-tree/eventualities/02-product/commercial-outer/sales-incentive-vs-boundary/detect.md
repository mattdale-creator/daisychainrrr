# sales-incentive-vs-boundary → detect

**Full path:** `02-product/commercial-outer/sales-incentive-vs-boundary/detect`

## Purpose
Operational leaf for the `sales-incentive-vs-boundary` eventuality: **detect**.
