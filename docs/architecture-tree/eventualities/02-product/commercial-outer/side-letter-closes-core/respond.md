# side-letter-closes-core → respond

**Full path:** `02-product/commercial-outer/side-letter-closes-core/respond`

## Purpose
Operational leaf for the `side-letter-closes-core` eventuality: **respond**.
