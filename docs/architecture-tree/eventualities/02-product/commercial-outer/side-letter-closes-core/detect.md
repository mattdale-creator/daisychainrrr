# side-letter-closes-core → detect

**Full path:** `02-product/commercial-outer/side-letter-closes-core/detect`

## Purpose
Operational leaf for the `side-letter-closes-core` eventuality: **detect**.
