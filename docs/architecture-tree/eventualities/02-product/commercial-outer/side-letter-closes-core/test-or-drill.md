# side-letter-closes-core → test-or-drill

**Full path:** `02-product/commercial-outer/side-letter-closes-core/test-or-drill`

## Purpose
Operational leaf for the `side-letter-closes-core` eventuality: **test-or-drill**.
