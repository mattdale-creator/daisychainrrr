# binding-not-merkle-linked → prevent

**Full path:** `02-product/ttlink/binding-not-merkle-linked/prevent`

## Purpose
Operational leaf for the `binding-not-merkle-linked` eventuality: **prevent**.
