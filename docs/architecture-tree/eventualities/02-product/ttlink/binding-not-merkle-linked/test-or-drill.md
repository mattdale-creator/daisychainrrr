# binding-not-merkle-linked → test-or-drill

**Full path:** `02-product/ttlink/binding-not-merkle-linked/test-or-drill`

## Purpose
Operational leaf for the `binding-not-merkle-linked` eventuality: **test-or-drill**.
