# binding-not-merkle-linked → respond

**Full path:** `02-product/ttlink/binding-not-merkle-linked/respond`

## Purpose
Operational leaf for the `binding-not-merkle-linked` eventuality: **respond**.
