# binding-not-merkle-linked → tombstone-criteria

**Full path:** `02-product/ttlink/binding-not-merkle-linked/tombstone-criteria`

## Purpose
Operational leaf for the `binding-not-merkle-linked` eventuality: **tombstone-criteria**.
