# approximate-presented-as-exact → tombstone-criteria

**Full path:** `02-product/ttlink/approximate-presented-as-exact/tombstone-criteria`

## Purpose
Operational leaf for the `approximate-presented-as-exact` eventuality: **tombstone-criteria**.
