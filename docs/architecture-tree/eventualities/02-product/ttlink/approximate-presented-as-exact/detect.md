...
**Path:** `eventualities/02-product/ttlink/approximate-presented-as-exact/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **ttlink** · failure · phase before public release or claim · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `02-product/ttlink/approximate-presented-as-exact/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
