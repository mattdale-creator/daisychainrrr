# approximate-presented-as-exact → test-or-drill

**Full path:** `02-product/ttlink/approximate-presented-as-exact/test-or-drill`

## Purpose
Operational leaf for the `approximate-presented-as-exact` eventuality: **test-or-drill**.
