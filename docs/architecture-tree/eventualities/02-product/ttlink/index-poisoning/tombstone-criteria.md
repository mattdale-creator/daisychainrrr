# index-poisoning → tombstone-criteria

**Full path:** `02-product/ttlink/index-poisoning/tombstone-criteria`

## Purpose
Operational leaf for the `index-poisoning` eventuality: **tombstone-criteria**.
