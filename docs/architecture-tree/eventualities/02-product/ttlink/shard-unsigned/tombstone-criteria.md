# shard-unsigned → tombstone-criteria

**Full path:** `02-product/ttlink/shard-unsigned/tombstone-criteria`

## Purpose
Operational leaf for the `shard-unsigned` eventuality: **tombstone-criteria**.
