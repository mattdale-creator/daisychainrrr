# latency-without-honest-slo → tombstone-criteria

**Full path:** `02-product/ttlink/latency-without-honest-slo/tombstone-criteria`

## Purpose
Operational leaf for the `latency-without-honest-slo` eventuality: **tombstone-criteria**.
