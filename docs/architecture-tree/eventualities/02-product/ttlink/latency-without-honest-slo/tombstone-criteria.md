# ttlink · tombstone-criteria

**Path:** `eventualities/02-product/ttlink/latency-without-honest-slo/tombstone-criteria.md`  
**Updated:** 2026-08-08  
**Leaf type:** tombstone-criteria — operational control for this eventuality

## Purpose
Operational control for this eventuality for: **ttlink** · failure · phase before public release or claim · actor project lead / founder.

## Procedure
1. Read parent `README.md` in this eventuality node.
2. Apply founding ethos: no soft tissue; verify with seals.
3. Log material actions in registers/incidents/ + redteam.
