# latency-without-honest-slo → detect

**Full path:** `02-product/ttlink/latency-without-honest-slo/detect`

## Purpose
Operational leaf for the `latency-without-honest-slo` eventuality: **detect**.
