# paywalled-basic-links → tombstone-criteria

**Full path:** `02-product/ttlink/paywalled-basic-links/tombstone-criteria`

## Purpose
Operational leaf for the `paywalled-basic-links` eventuality: **tombstone-criteria**.
