# paywalled-basic-links → prevent

**Full path:** `02-product/ttlink/paywalled-basic-links/prevent`

## Purpose
Operational leaf for the `paywalled-basic-links` eventuality: **prevent**.
