# paywalled-basic-links → test-or-drill

**Full path:** `02-product/ttlink/paywalled-basic-links/test-or-drill`

## Purpose
Operational leaf for the `paywalled-basic-links` eventuality: **test-or-drill**.
