# query-abuse-bulk-extract → test-or-drill

**Full path:** `02-product/ttlink/query-abuse-bulk-extract/test-or-drill`

## Purpose
Operational leaf for the `query-abuse-bulk-extract` eventuality: **test-or-drill**.
