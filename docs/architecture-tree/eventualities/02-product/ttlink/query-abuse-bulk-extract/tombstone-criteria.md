# query-abuse-bulk-extract → tombstone-criteria

**Full path:** `02-product/ttlink/query-abuse-bulk-extract/tombstone-criteria`

## Purpose
Operational leaf for the `query-abuse-bulk-extract` eventuality: **tombstone-criteria**.
