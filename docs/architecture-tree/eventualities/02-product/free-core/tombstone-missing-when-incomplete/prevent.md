# tombstone-missing-when-incomplete → prevent

**Full path:** `02-product/free-core/tombstone-missing-when-incomplete/prevent`

## Purpose
Operational leaf for the `tombstone-missing-when-incomplete` eventuality: **prevent**.
