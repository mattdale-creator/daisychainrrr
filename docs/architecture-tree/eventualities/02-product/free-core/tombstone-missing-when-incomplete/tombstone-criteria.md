# tombstone-missing-when-incomplete → tombstone-criteria

**Full path:** `02-product/free-core/tombstone-missing-when-incomplete/tombstone-criteria`

## Purpose
Operational leaf for the `tombstone-missing-when-incomplete` eventuality: **tombstone-criteria**.
