# tombstone-missing-when-incomplete → detect

**Full path:** `02-product/free-core/tombstone-missing-when-incomplete/detect`

## Purpose
Operational leaf for the `tombstone-missing-when-incomplete` eventuality: **detect**.
