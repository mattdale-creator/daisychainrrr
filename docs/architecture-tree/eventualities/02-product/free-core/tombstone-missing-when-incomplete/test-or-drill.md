# tombstone-missing-when-incomplete → test-or-drill

**Full path:** `02-product/free-core/tombstone-missing-when-incomplete/test-or-drill`

## Purpose
Operational leaf for the `tombstone-missing-when-incomplete` eventuality: **test-or-drill**.
