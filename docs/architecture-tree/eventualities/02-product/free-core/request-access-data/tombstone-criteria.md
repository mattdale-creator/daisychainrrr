# request-access-data → tombstone-criteria

**Full path:** `02-product/free-core/request-access-data/tombstone-criteria`

## Purpose
Operational leaf for the `request-access-data` eventuality: **tombstone-criteria**.
