# quiet-paywall → tombstone-criteria

**Full path:** `02-product/free-core/quiet-paywall/tombstone-criteria`

## Purpose
Operational leaf for the `quiet-paywall` eventuality: **tombstone-criteria**.
