# query-oracle-side-channel → respond

**Full path:** `04-security/transparency-layer/query-oracle-side-channel/respond`

## Purpose
Operational leaf for the `query-oracle-side-channel` eventuality: **respond**.
