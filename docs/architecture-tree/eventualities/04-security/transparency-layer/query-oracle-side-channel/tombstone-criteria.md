# query-oracle-side-channel → tombstone-criteria

**Full path:** `04-security/transparency-layer/query-oracle-side-channel/tombstone-criteria`

## Purpose
Operational leaf for the `query-oracle-side-channel` eventuality: **tombstone-criteria**.
