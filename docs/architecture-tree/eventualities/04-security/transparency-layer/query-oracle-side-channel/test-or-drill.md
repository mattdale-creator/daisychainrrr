# query-oracle-side-channel → test-or-drill

**Full path:** `04-security/transparency-layer/query-oracle-side-channel/test-or-drill`

## Purpose
Operational leaf for the `query-oracle-side-channel` eventuality: **test-or-drill**.
