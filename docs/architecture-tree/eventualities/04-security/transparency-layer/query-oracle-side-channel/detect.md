# query-oracle-side-channel → detect

**Full path:** `04-security/transparency-layer/query-oracle-side-channel/detect`

## Purpose
Operational leaf for the `query-oracle-side-channel` eventuality: **detect**.
