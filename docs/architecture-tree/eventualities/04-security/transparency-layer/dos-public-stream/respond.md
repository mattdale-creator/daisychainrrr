# dos-public-stream → respond

**Full path:** `04-security/transparency-layer/dos-public-stream/respond`

## Purpose
Operational leaf for the `dos-public-stream` eventuality: **respond**.
