# dos-public-stream → detect

**Full path:** `04-security/transparency-layer/dos-public-stream/detect`

## Purpose
Operational leaf for the `dos-public-stream` eventuality: **detect**.
