# manifest-forgery → respond

**Full path:** `04-security/transparency-layer/manifest-forgery/respond`

## Purpose
Operational leaf for the `manifest-forgery` eventuality: **respond**.
