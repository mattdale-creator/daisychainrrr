# manifest-forgery → tombstone-criteria

**Full path:** `04-security/transparency-layer/manifest-forgery/tombstone-criteria`

## Purpose
Operational leaf for the `manifest-forgery` eventuality: **tombstone-criteria**.
