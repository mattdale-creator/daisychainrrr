# manifest-forgery → prevent

**Full path:** `04-security/transparency-layer/manifest-forgery/prevent`

## Purpose
Operational leaf for the `manifest-forgery` eventuality: **prevent**.
