# 04-security/transparency-layer-deep/shard-root-mismatch/detect.md · detect

**Path:** `eventualities/04-security/transparency-layer-deep/shard-root-mismatch/detect.md`  
**Updated:** 2026-08-08  
...
## Output of detection
Write a one-paragraph incident/note with: path `04-security/transparency-layer-deep/shard-root-mismatch/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
