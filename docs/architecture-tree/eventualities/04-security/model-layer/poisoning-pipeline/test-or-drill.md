# poisoning-pipeline → test-or-drill

**Full path:** `04-security/model-layer/poisoning-pipeline/test-or-drill`

## Purpose
Operational leaf for the `poisoning-pipeline` eventuality: **test-or-drill**.
