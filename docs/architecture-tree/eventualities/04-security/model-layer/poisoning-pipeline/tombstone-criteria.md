# poisoning-pipeline → tombstone-criteria

**Full path:** `04-security/model-layer/poisoning-pipeline/tombstone-criteria`

## Purpose
Operational leaf for the `poisoning-pipeline` eventuality: **tombstone-criteria**.
