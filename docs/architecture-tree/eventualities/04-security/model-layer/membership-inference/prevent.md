# membership-inference → prevent

**Full path:** `04-security/model-layer/membership-inference/prevent`

## Purpose
Operational leaf for the `membership-inference` eventuality: **prevent**.
