# membership-inference → test-or-drill

**Full path:** `04-security/model-layer/membership-inference/test-or-drill`

## Purpose
Operational leaf for the `membership-inference` eventuality: **test-or-drill**.
