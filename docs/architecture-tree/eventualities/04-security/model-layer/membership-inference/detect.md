# membership-inference → detect

**Full path:** `04-security/model-layer/membership-inference/detect`

## Purpose
Operational leaf for the `membership-inference` eventuality: **detect**.
