# jailbreak-untested → tombstone-criteria

**Full path:** `04-security/model-layer/jailbreak-untested/tombstone-criteria`

## Purpose
Operational leaf for the `jailbreak-untested` eventuality: **tombstone-criteria**.
