# public-data-changes-threat-model → test-or-drill

**Full path:** `04-security/model-layer/public-data-changes-threat-model/test-or-drill`

## Purpose
Operational leaf for the `public-data-changes-threat-model` eventuality: **test-or-drill**.
