# public-data-changes-threat-model → tombstone-criteria

**Full path:** `04-security/model-layer/public-data-changes-threat-model/tombstone-criteria`

## Purpose
Operational leaf for the `public-data-changes-threat-model` eventuality: **tombstone-criteria**.
