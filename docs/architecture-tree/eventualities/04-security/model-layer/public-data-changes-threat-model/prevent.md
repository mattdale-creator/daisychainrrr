# public-data-changes-threat-model → prevent

**Full path:** `04-security/model-layer/public-data-changes-threat-model/prevent`

## Purpose
Operational leaf for the `public-data-changes-threat-model` eventuality: **prevent**.
