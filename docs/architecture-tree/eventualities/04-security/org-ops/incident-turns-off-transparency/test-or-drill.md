# incident-turns-off-transparency → test-or-drill

**Full path:** `04-security/org-ops/incident-turns-off-transparency/test-or-drill`

## Purpose
Operational leaf for the `incident-turns-off-transparency` eventuality: **test-or-drill**.
