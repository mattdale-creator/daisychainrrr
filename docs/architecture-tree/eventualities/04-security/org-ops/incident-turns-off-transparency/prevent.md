# incident-turns-off-transparency → prevent

**Full path:** `04-security/org-ops/incident-turns-off-transparency/prevent`

## Purpose
Operational leaf for the `incident-turns-off-transparency` eventuality: **prevent**.
