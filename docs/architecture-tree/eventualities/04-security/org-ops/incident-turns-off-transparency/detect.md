# incident-turns-off-transparency → detect

**Full path:** `04-security/org-ops/incident-turns-off-transparency/detect`

## Purpose
Operational leaf for the `incident-turns-off-transparency` eventuality: **detect**.
