# incident-turns-off-transparency → tombstone-criteria

**Full path:** `04-security/org-ops/incident-turns-off-transparency/tombstone-criteria`

## Purpose
Operational leaf for the `incident-turns-off-transparency` eventuality: **tombstone-criteria**.
