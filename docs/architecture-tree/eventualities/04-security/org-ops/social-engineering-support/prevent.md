# social-engineering-support → prevent

**Full path:** `04-security/org-ops/social-engineering-support/prevent`

## Purpose
Operational leaf for the `social-engineering-support` eventuality: **prevent**.
