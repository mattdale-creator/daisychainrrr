# privilege-escalation → tombstone-criteria

**Full path:** `04-security/commercial-arm/privilege-escalation/tombstone-criteria`

## Purpose
Operational leaf for the `privilege-escalation` eventuality: **tombstone-criteria**.
