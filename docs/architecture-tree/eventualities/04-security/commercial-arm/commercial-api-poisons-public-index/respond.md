# commercial-api-poisons-public-index → respond

**Full path:** `04-security/commercial-arm/commercial-api-poisons-public-index/respond`

## Purpose
Operational leaf for the `commercial-api-poisons-public-index` eventuality: **respond**.
