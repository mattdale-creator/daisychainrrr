# commercial-api-poisons-public-index → detect

**Full path:** `04-security/commercial-arm/commercial-api-poisons-public-index/detect`

## Purpose
Operational leaf for the `commercial-api-poisons-public-index` eventuality: **detect**.
