# billing-fraud → test-or-drill

**Full path:** `04-security/commercial-arm/billing-fraud/test-or-drill`

## Purpose
Operational leaf for the `billing-fraud` eventuality: **test-or-drill**.
