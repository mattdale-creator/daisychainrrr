# cross-tenant-leak → test-or-drill

**Full path:** `04-security/commercial-arm/cross-tenant-leak/test-or-drill`

## Purpose
Operational leaf for the `cross-tenant-leak` eventuality: **test-or-drill**.
