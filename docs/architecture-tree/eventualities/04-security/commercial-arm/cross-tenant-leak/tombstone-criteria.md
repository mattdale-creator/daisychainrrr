# cross-tenant-leak → tombstone-criteria

**Full path:** `04-security/commercial-arm/cross-tenant-leak/tombstone-criteria`

## Purpose
Operational leaf for the `cross-tenant-leak` eventuality: **tombstone-criteria**.
