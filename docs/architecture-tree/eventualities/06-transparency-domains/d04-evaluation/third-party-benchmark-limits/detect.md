# third-party-benchmark-limits → detect

**Full path:** `06-transparency-domains/d04-evaluation/third-party-benchmark-limits/detect`

## Purpose
Operational leaf for the `third-party-benchmark-limits` eventuality: **detect**.
