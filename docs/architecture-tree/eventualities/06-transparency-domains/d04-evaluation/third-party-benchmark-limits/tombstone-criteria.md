# third-party-benchmark-limits → tombstone-criteria

**Full path:** `06-transparency-domains/d04-evaluation/third-party-benchmark-limits/tombstone-criteria`

## Purpose
Operational leaf for the `third-party-benchmark-limits` eventuality: **tombstone-criteria**.
