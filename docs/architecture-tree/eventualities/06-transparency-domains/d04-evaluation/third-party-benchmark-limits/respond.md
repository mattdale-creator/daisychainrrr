# third-party-benchmark-limits → respond

**Full path:** `06-transparency-domains/d04-evaluation/third-party-benchmark-limits/respond`

## Purpose
Operational leaf for the `third-party-benchmark-limits` eventuality: **respond**.
