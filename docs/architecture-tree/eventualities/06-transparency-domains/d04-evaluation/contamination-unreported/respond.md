# contamination-unreported → respond

**Full path:** `06-transparency-domains/d04-evaluation/contamination-unreported/respond`

## Purpose
Operational leaf for the `contamination-unreported` eventuality: **respond**.
