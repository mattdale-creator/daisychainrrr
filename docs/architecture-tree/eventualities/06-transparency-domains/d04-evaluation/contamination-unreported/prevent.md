# contamination-unreported → prevent

**Full path:** `06-transparency-domains/d04-evaluation/contamination-unreported/prevent`

## Purpose
Operational leaf for the `contamination-unreported` eventuality: **prevent**.
