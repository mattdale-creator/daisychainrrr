# contamination-unreported → tombstone-criteria

**Full path:** `06-transparency-domains/d04-evaluation/contamination-unreported/tombstone-criteria`

## Purpose
Operational leaf for the `contamination-unreported` eventuality: **tombstone-criteria**.
