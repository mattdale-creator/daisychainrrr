# contamination-unreported → detect

**Full path:** `06-transparency-domains/d04-evaluation/contamination-unreported/detect`

## Purpose
Operational leaf for the `contamination-unreported` eventuality: **detect**.
