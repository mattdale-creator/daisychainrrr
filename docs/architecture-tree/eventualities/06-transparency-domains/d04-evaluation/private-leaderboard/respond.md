# private-leaderboard → respond

**Full path:** `06-transparency-domains/d04-evaluation/private-leaderboard/respond`

## Purpose
Operational leaf for the `private-leaderboard` eventuality: **respond**.
