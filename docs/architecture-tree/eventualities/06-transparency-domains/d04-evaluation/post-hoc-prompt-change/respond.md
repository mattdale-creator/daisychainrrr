# post-hoc-prompt-change → respond

**Full path:** `06-transparency-domains/d04-evaluation/post-hoc-prompt-change/respond`

## Purpose
Operational leaf for the `post-hoc-prompt-change` eventuality: **respond**.
