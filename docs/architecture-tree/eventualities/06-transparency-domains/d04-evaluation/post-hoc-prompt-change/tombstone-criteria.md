# post-hoc-prompt-change → tombstone-criteria

**Full path:** `06-transparency-domains/d04-evaluation/post-hoc-prompt-change/tombstone-criteria`

## Purpose
Operational leaf for the `post-hoc-prompt-change` eventuality: **tombstone-criteria**.
