# post-hoc-prompt-change → detect

**Full path:** `06-transparency-domains/d04-evaluation/post-hoc-prompt-change/detect`

## Purpose
Operational leaf for the `post-hoc-prompt-change` eventuality: **detect**.
