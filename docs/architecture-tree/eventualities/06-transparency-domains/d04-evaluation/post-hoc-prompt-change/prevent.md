# post-hoc-prompt-change → prevent

**Full path:** `06-transparency-domains/d04-evaluation/post-hoc-prompt-change/prevent`

## Purpose
Operational leaf for the `post-hoc-prompt-change` eventuality: **prevent**.
