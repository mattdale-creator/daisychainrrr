# anonymisation-abused → tombstone-criteria

**Full path:** `06-transparency-domains/d02-ownership/anonymisation-abused/tombstone-criteria`

## Purpose
Operational leaf for the `anonymisation-abused` eventuality: **tombstone-criteria**.
