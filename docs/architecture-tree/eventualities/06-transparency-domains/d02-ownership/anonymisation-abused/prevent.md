# anonymisation-abused → prevent

**Full path:** `06-transparency-domains/d02-ownership/anonymisation-abused/prevent`

## Purpose
Operational leaf for the `anonymisation-abused` eventuality: **prevent**.
