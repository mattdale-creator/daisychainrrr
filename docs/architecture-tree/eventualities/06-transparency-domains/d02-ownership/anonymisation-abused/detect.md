# anonymisation-abused → detect

**Full path:** `06-transparency-domains/d02-ownership/anonymisation-abused/detect`

## Purpose
Operational leaf for the `anonymisation-abused` eventuality: **detect**.
