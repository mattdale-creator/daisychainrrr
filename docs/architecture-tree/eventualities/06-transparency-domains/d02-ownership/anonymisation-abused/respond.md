# anonymisation-abused → respond

**Full path:** `06-transparency-domains/d02-ownership/anonymisation-abused/respond`

## Purpose
Operational leaf for the `anonymisation-abused` eventuality: **respond**.
