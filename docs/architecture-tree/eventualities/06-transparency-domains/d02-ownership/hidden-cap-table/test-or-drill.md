# hidden-cap-table → test-or-drill

**Full path:** `06-transparency-domains/d02-ownership/hidden-cap-table/test-or-drill`

## Purpose
Operational leaf for the `hidden-cap-table` eventuality: **test-or-drill**.
