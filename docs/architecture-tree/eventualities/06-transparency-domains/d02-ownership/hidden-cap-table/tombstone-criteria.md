# hidden-cap-table → tombstone-criteria

**Full path:** `06-transparency-domains/d02-ownership/hidden-cap-table/tombstone-criteria`

## Purpose
Operational leaf for the `hidden-cap-table` eventuality: **tombstone-criteria**.
