# hidden-cap-table → detect

**Full path:** `06-transparency-domains/d02-ownership/hidden-cap-table/detect`

## Purpose
Operational leaf for the `hidden-cap-table` eventuality: **detect**.
