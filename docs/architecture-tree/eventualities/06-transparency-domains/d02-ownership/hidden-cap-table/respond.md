# hidden-cap-table → respond

**Full path:** `06-transparency-domains/d02-ownership/hidden-cap-table/respond`

## Purpose
Operational leaf for the `hidden-cap-table` eventuality: **respond**.
