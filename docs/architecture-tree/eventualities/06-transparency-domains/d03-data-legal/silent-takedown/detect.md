# silent-takedown → detect

**Full path:** `06-transparency-domains/d03-data-legal/silent-takedown/detect`

## Purpose
Operational leaf for the `silent-takedown` eventuality: **detect**.
