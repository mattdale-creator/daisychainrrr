# silent-takedown → tombstone-criteria

**Full path:** `06-transparency-domains/d03-data-legal/silent-takedown/tombstone-criteria`

## Purpose
Operational leaf for the `silent-takedown` eventuality: **tombstone-criteria**.
