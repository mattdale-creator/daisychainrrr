# under-logging-changes → test-or-drill

**Full path:** `06-transparency-domains/d03-data-legal/under-logging-changes/test-or-drill`

## Purpose
Operational leaf for the `under-logging-changes` eventuality: **test-or-drill**.
