# under-logging-changes → detect

**Full path:** `06-transparency-domains/d03-data-legal/under-logging-changes/detect`

## Purpose
Operational leaf for the `under-logging-changes` eventuality: **detect**.
