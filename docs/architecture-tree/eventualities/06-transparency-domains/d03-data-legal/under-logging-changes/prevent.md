# under-logging-changes → prevent

**Full path:** `06-transparency-domains/d03-data-legal/under-logging-changes/prevent`

## Purpose
Operational leaf for the `under-logging-changes` eventuality: **prevent**.
