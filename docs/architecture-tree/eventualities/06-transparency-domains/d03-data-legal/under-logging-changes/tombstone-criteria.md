# under-logging-changes → tombstone-criteria

**Full path:** `06-transparency-domains/d03-data-legal/under-logging-changes/tombstone-criteria`

## Purpose
Operational leaf for the `under-logging-changes` eventuality: **tombstone-criteria**.
