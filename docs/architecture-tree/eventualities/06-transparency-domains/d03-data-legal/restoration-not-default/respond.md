# restoration-not-default → respond

**Full path:** `06-transparency-domains/d03-data-legal/restoration-not-default/respond`

## Purpose
Operational leaf for the `restoration-not-default` eventuality: **respond**.
