# restoration-not-default → prevent

**Full path:** `06-transparency-domains/d03-data-legal/restoration-not-default/prevent`

## Purpose
Operational leaf for the `restoration-not-default` eventuality: **prevent**.
