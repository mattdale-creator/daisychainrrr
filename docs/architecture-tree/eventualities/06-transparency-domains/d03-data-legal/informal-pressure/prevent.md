# informal-pressure → prevent

**Full path:** `06-transparency-domains/d03-data-legal/informal-pressure/prevent`

## Purpose
Operational leaf for the `informal-pressure` eventuality: **prevent**.
