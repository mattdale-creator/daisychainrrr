# informal-pressure → detect

**Full path:** `06-transparency-domains/d03-data-legal/informal-pressure/detect`

## Purpose
Operational leaf for the `informal-pressure` eventuality: **detect**.
