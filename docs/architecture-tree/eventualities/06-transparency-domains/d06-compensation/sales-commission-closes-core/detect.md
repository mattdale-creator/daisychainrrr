# sales-commission-closes-core → detect

**Full path:** `06-transparency-domains/d06-compensation/sales-commission-closes-core/detect`

## Purpose
Operational leaf for the `sales-commission-closes-core` eventuality: **detect**.
