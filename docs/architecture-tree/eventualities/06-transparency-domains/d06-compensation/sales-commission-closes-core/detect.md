# 06-transparency-domains/d06-compensation/sales-commission-closes-core/detect.md · detect

**Path:** `eventualities/06-transparency-domains/d06-compensation/sales-commission-closes-core/detect.md`  
**Updated:** 2026-08-08  
...
## Output of detection
Write a one-paragraph incident/note with: path `06-transparency-domains/d06-compensation/sales-commission-closes-core/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
