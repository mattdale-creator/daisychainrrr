# sales-commission-closes-core → tombstone-criteria

**Full path:** `06-transparency-domains/d06-compensation/sales-commission-closes-core/tombstone-criteria`

## Purpose
Operational leaf for the `sales-commission-closes-core` eventuality: **tombstone-criteria**.
