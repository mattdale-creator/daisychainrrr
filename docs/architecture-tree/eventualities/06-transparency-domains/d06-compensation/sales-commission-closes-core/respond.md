# sales-commission-closes-core → respond

**Full path:** `06-transparency-domains/d06-compensation/sales-commission-closes-core/respond`

## Purpose
Operational leaf for the `sales-commission-closes-core` eventuality: **respond**.
