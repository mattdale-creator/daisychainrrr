# informal-status-untracked → prevent

**Full path:** `06-transparency-domains/d06-compensation/informal-status-untracked/prevent`

## Purpose
Operational leaf for the `informal-status-untracked` eventuality: **prevent**.
