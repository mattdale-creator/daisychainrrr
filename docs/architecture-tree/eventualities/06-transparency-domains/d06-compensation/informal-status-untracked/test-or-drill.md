# informal-status-untracked → test-or-drill

**Full path:** `06-transparency-domains/d06-compensation/informal-status-untracked/test-or-drill`

## Purpose
Operational leaf for the `informal-status-untracked` eventuality: **test-or-drill**.
