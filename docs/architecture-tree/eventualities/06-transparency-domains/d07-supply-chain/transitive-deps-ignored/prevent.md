# transitive-deps-ignored → prevent

**Full path:** `06-transparency-domains/d07-supply-chain/transitive-deps-ignored/prevent`

## Purpose
Operational leaf for the `transitive-deps-ignored` eventuality: **prevent**.
