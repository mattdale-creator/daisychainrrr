# transitive-deps-ignored → respond

**Full path:** `06-transparency-domains/d07-supply-chain/transitive-deps-ignored/respond`

## Purpose
Operational leaf for the `transitive-deps-ignored` eventuality: **respond**.
