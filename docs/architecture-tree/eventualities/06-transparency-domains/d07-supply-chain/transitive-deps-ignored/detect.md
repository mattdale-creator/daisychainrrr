# transitive-deps-ignored → detect

**Full path:** `06-transparency-domains/d07-supply-chain/transitive-deps-ignored/detect`

## Purpose
Operational leaf for the `transitive-deps-ignored` eventuality: **detect**.
