# transitive-deps-ignored → tombstone-criteria

**Full path:** `06-transparency-domains/d07-supply-chain/transitive-deps-ignored/tombstone-criteria`

## Purpose
Operational leaf for the `transitive-deps-ignored` eventuality: **tombstone-criteria**.
