# provider-non-disclosure → respond

**Full path:** `06-transparency-domains/d07-supply-chain/provider-non-disclosure/respond`

## Purpose
Operational leaf for the `provider-non-disclosure` eventuality: **respond**.
