# provider-non-disclosure → detect

**Full path:** `06-transparency-domains/d07-supply-chain/provider-non-disclosure/detect`

## Purpose
Operational leaf for the `provider-non-disclosure` eventuality: **detect**.
