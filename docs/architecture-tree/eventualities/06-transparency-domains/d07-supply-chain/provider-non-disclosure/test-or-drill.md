# provider-non-disclosure → test-or-drill

**Full path:** `06-transparency-domains/d07-supply-chain/provider-non-disclosure/test-or-drill`

## Purpose
Operational leaf for the `provider-non-disclosure` eventuality: **test-or-drill**.
