# provider-non-disclosure → prevent

**Full path:** `06-transparency-domains/d07-supply-chain/provider-non-disclosure/prevent`

## Purpose
Operational leaf for the `provider-non-disclosure` eventuality: **prevent**.
