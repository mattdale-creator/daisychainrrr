# provider-non-disclosure → tombstone-criteria

**Full path:** `06-transparency-domains/d07-supply-chain/provider-non-disclosure/tombstone-criteria`

## Purpose
Operational leaf for the `provider-non-disclosure` eventuality: **tombstone-criteria**.
