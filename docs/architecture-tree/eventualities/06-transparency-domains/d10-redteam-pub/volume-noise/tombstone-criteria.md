# volume-noise → tombstone-criteria

**Full path:** `06-transparency-domains/d10-redteam-pub/volume-noise/tombstone-criteria`

## Purpose
Operational leaf for the `volume-noise` eventuality: **tombstone-criteria**.
