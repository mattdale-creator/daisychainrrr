# findings-suppressed → tombstone-criteria

**Full path:** `06-transparency-domains/d10-redteam-pub/findings-suppressed/tombstone-criteria`

## Purpose
Operational leaf for the `findings-suppressed` eventuality: **tombstone-criteria**.
