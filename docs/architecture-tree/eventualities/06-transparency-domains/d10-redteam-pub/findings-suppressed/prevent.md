# findings-suppressed → prevent

**Full path:** `06-transparency-domains/d10-redteam-pub/findings-suppressed/prevent`

## Purpose
Operational leaf for the `findings-suppressed` eventuality: **prevent**.
