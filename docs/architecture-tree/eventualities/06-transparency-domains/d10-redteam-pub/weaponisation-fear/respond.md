# weaponisation-fear → respond

**Full path:** `06-transparency-domains/d10-redteam-pub/weaponisation-fear/respond`

## Purpose
Operational leaf for the `weaponisation-fear` eventuality: **respond**.
