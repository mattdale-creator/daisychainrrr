# weaponisation-fear → tombstone-criteria

**Full path:** `06-transparency-domains/d10-redteam-pub/weaponisation-fear/tombstone-criteria`

## Purpose
Operational leaf for the `weaponisation-fear` eventuality: **tombstone-criteria**.
