# weaponisation-fear → prevent

**Full path:** `06-transparency-domains/d10-redteam-pub/weaponisation-fear/prevent`

## Purpose
Operational leaf for the `weaponisation-fear` eventuality: **prevent**.
