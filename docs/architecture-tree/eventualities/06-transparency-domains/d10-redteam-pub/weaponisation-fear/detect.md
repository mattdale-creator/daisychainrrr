# weaponisation-fear → detect

**Full path:** `06-transparency-domains/d10-redteam-pub/weaponisation-fear/detect`

## Purpose
Operational leaf for the `weaponisation-fear` eventuality: **detect**.
