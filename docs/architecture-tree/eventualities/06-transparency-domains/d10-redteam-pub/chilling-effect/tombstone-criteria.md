# chilling-effect → tombstone-criteria

**Full path:** `06-transparency-domains/d10-redteam-pub/chilling-effect/tombstone-criteria`

## Purpose
Operational leaf for the `chilling-effect` eventuality: **tombstone-criteria**.
