# chilling-effect → prevent

**Full path:** `06-transparency-domains/d10-redteam-pub/chilling-effect/prevent`

## Purpose
Operational leaf for the `chilling-effect` eventuality: **prevent**.
