# chilling-effect → detect

**Full path:** `06-transparency-domains/d10-redteam-pub/chilling-effect/detect`

## Purpose
Operational leaf for the `chilling-effect` eventuality: **detect**.
