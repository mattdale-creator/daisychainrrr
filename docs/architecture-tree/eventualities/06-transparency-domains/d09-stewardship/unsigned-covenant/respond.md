# unsigned-covenant → respond

**Full path:** `06-transparency-domains/d09-stewardship/unsigned-covenant/respond`

## Purpose
Operational leaf for the `unsigned-covenant` eventuality: **respond**.
