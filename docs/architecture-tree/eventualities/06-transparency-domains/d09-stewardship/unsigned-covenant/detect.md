# unsigned-covenant → detect

**Full path:** `06-transparency-domains/d09-stewardship/unsigned-covenant/detect`

## Purpose
Operational leaf for the `unsigned-covenant` eventuality: **detect**.
