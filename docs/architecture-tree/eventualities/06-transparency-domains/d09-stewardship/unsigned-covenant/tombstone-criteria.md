# unsigned-covenant → tombstone-criteria

**Full path:** `06-transparency-domains/d09-stewardship/unsigned-covenant/tombstone-criteria`

## Purpose
Operational leaf for the `unsigned-covenant` eventuality: **tombstone-criteria**.
