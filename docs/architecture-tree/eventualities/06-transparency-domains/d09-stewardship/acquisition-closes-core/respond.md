# acquisition-closes-core → respond

**Full path:** `06-transparency-domains/d09-stewardship/acquisition-closes-core/respond`

## Purpose
Operational leaf for the `acquisition-closes-core` eventuality: **respond**.
