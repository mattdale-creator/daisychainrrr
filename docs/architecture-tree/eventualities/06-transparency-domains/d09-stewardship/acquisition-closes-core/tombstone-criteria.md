# acquisition-closes-core → tombstone-criteria

**Full path:** `06-transparency-domains/d09-stewardship/acquisition-closes-core/tombstone-criteria`

## Purpose
Operational leaf for the `acquisition-closes-core` eventuality: **tombstone-criteria**.
