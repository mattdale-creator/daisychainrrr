# early-gaps-hidden → respond

**Full path:** `06-transparency-domains/d09-stewardship/early-gaps-hidden/respond`

## Purpose
Operational leaf for the `early-gaps-hidden` eventuality: **respond**.
