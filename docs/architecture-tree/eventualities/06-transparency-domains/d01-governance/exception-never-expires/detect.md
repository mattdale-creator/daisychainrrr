# exception-never-expires → detect

**Full path:** `06-transparency-domains/d01-governance/exception-never-expires/detect`

## Purpose
Operational leaf for the `exception-never-expires` eventuality: **detect**.
