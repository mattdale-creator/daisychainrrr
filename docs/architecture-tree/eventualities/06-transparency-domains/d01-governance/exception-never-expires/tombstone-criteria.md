# exception-never-expires → tombstone-criteria

**Full path:** `06-transparency-domains/d01-governance/exception-never-expires/tombstone-criteria`

## Purpose
Operational leaf for the `exception-never-expires` eventuality: **tombstone-criteria**.
