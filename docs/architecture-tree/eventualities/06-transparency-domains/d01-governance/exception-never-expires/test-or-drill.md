# exception-never-expires → test-or-drill

**Full path:** `06-transparency-domains/d01-governance/exception-never-expires/test-or-drill`

## Purpose
Operational leaf for the `exception-never-expires` eventuality: **test-or-drill**.
