# exception-never-expires → respond

**Full path:** `06-transparency-domains/d01-governance/exception-never-expires/respond`

## Purpose
Operational leaf for the `exception-never-expires` eventuality: **respond**.
