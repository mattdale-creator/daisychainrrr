# speed-vs-docs → test-or-drill

**Full path:** `06-transparency-domains/d01-governance/speed-vs-docs/test-or-drill`

## Purpose
Operational leaf for the `speed-vs-docs` eventuality: **test-or-drill**.
