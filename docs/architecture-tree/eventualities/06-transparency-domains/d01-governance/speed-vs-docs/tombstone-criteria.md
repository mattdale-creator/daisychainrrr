# speed-vs-docs → tombstone-criteria

**Full path:** `06-transparency-domains/d01-governance/speed-vs-docs/tombstone-criteria`

## Purpose
Operational leaf for the `speed-vs-docs` eventuality: **tombstone-criteria**.
