# 06-transparency-domains/d01-governance/speed-vs-docs/detect.md · detect

**Path:** `eventualities/06-transparency-domains/d01-governance/speed-vs-docs/detect.md`  
**Updated:** 2026-08-08  
...
## Output of detection
Write a one-paragraph incident/note with: path `06-transparency-domains/d01-governance/speed-vs-docs/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
