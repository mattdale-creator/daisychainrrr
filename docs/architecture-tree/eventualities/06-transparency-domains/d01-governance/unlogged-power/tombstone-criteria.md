# unlogged-power → tombstone-criteria

**Full path:** `06-transparency-domains/d01-governance/unlogged-power/tombstone-criteria`

## Purpose
Operational leaf for the `unlogged-power` eventuality: **tombstone-criteria**.
