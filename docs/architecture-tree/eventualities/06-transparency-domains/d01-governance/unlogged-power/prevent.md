# unlogged-power → prevent

**Full path:** `06-transparency-domains/d01-governance/unlogged-power/prevent`

## Purpose
Operational leaf for the `unlogged-power` eventuality: **prevent**.
