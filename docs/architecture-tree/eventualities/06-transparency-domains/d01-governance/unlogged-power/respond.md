# unlogged-power → respond

**Full path:** `06-transparency-domains/d01-governance/unlogged-power/respond`

## Purpose
Operational leaf for the `unlogged-power` eventuality: **respond**.
