# gradual-erosion → detect

**Full path:** `06-transparency-domains/d08-boundary/gradual-erosion/detect`

## Purpose
Operational leaf for the `gradual-erosion` eventuality: **detect**.
