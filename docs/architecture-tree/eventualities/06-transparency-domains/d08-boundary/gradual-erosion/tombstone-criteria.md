# gradual-erosion → tombstone-criteria

**Full path:** `06-transparency-domains/d08-boundary/gradual-erosion/tombstone-criteria`

## Purpose
Operational leaf for the `gradual-erosion` eventuality: **tombstone-criteria**.
