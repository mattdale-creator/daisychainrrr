# gradual-erosion → prevent

**Full path:** `06-transparency-domains/d08-boundary/gradual-erosion/prevent`

## Purpose
Operational leaf for the `gradual-erosion` eventuality: **prevent**.
