# customer-exclusivity-request → test-or-drill

**Full path:** `06-transparency-domains/d08-boundary/customer-exclusivity-request/test-or-drill`

## Purpose
Operational leaf for the `customer-exclusivity-request` eventuality: **test-or-drill**.
