# customer-exclusivity-request → tombstone-criteria

**Full path:** `06-transparency-domains/d08-boundary/customer-exclusivity-request/tombstone-criteria`

## Purpose
Operational leaf for the `customer-exclusivity-request` eventuality: **tombstone-criteria**.
