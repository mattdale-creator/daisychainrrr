# customer-exclusivity-request → detect

**Full path:** `06-transparency-domains/d08-boundary/customer-exclusivity-request/detect`

## Purpose
Operational leaf for the `customer-exclusivity-request` eventuality: **detect**.
