# customer-exclusivity-request → respond

**Full path:** `06-transparency-domains/d08-boundary/customer-exclusivity-request/respond`

## Purpose
Operational leaf for the `customer-exclusivity-request` eventuality: **respond**.
