# edge-case-finetune → detect

**Full path:** `06-transparency-domains/d08-boundary/edge-case-finetune/detect`

## Purpose
Operational leaf for the `edge-case-finetune` eventuality: **detect**.
