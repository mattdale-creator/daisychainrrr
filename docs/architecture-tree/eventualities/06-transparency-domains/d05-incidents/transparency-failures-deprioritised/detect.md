# transparency-failures-deprioritised → detect

**Full path:** `06-transparency-domains/d05-incidents/transparency-failures-deprioritised/detect`

## Purpose
Operational leaf for the `transparency-failures-deprioritised` eventuality: **detect**.
