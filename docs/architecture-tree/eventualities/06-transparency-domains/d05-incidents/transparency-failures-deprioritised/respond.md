# transparency-failures-deprioritised → respond

**Full path:** `06-transparency-domains/d05-incidents/transparency-failures-deprioritised/respond`

## Purpose
Operational leaf for the `transparency-failures-deprioritised` eventuality: **respond**.
