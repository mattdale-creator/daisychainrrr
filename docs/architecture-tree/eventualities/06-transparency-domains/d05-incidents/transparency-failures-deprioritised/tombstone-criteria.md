# transparency-failures-deprioritised → tombstone-criteria

**Full path:** `06-transparency-domains/d05-incidents/transparency-failures-deprioritised/tombstone-criteria`

## Purpose
Operational leaf for the `transparency-failures-deprioritised` eventuality: **tombstone-criteria**.
