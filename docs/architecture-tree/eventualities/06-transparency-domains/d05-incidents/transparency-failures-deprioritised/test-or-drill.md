# transparency-failures-deprioritised → test-or-drill

**Full path:** `06-transparency-domains/d05-incidents/transparency-failures-deprioritised/test-or-drill`

## Purpose
Operational leaf for the `transparency-failures-deprioritised` eventuality: **test-or-drill**.
