# security-exemption-permanent → respond

**Full path:** `06-transparency-domains/d05-incidents/security-exemption-permanent/respond`

## Purpose
Operational leaf for the `security-exemption-permanent` eventuality: **respond**.
