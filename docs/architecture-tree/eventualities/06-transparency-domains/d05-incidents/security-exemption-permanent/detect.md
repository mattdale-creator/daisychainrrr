# security-exemption-permanent → detect

**Full path:** `06-transparency-domains/d05-incidents/security-exemption-permanent/detect`

## Purpose
Operational leaf for the `security-exemption-permanent` eventuality: **detect**.
