# selective-silence → respond

**Full path:** `06-transparency-domains/d05-incidents/selective-silence/respond`

## Purpose
Operational leaf for the `selective-silence` eventuality: **respond**.
