# selective-silence → detect

**Full path:** `06-transparency-domains/d05-incidents/selective-silence/detect`

## Purpose
Operational leaf for the `selective-silence` eventuality: **detect**.
