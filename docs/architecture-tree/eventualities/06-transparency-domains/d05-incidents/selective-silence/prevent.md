# selective-silence → prevent

**Full path:** `06-transparency-domains/d05-incidents/selective-silence/prevent`

## Purpose
Operational leaf for the `selective-silence` eventuality: **prevent**.
