# matrix-aesthetic-without-links → respond

**Full path:** `01-ethos/topology-optimisation/matrix-aesthetic-without-links/respond`

## Purpose
Operational leaf for the `matrix-aesthetic-without-links` eventuality: **respond**.
