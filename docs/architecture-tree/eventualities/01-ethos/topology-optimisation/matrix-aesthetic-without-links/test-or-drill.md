# matrix-aesthetic-without-links → test-or-drill

**Full path:** `01-ethos/topology-optimisation/matrix-aesthetic-without-links/test-or-drill`

## Purpose
Operational leaf for the `matrix-aesthetic-without-links` eventuality: **test-or-drill**.
