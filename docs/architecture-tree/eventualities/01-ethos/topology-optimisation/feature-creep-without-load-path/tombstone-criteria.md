# feature-creep-without-load-path → tombstone-criteria

**Full path:** `01-ethos/topology-optimisation/feature-creep-without-load-path/tombstone-criteria`

## Purpose
Operational leaf for the `feature-creep-without-load-path` eventuality: **tombstone-criteria**.
