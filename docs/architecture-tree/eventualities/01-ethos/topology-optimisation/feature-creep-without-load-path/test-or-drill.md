# feature-creep-without-load-path → test-or-drill

**Full path:** `01-ethos/topology-optimisation/feature-creep-without-load-path/test-or-drill`

## Purpose
Operational leaf for the `feature-creep-without-load-path` eventuality: **test-or-drill**.
