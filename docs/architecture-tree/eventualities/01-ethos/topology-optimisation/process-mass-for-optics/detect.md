# process-mass-for-optics → detect

**Full path:** `01-ethos/topology-optimisation/process-mass-for-optics/detect`

## Purpose
Operational leaf for the `process-mass-for-optics` eventuality: **detect**.
