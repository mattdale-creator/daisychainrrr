# deletion-not-rewarded → prevent

**Full path:** `01-ethos/down-to-the-bone/deletion-not-rewarded/prevent`

## Purpose
Operational leaf for the `deletion-not-rewarded` eventuality: **prevent**.
