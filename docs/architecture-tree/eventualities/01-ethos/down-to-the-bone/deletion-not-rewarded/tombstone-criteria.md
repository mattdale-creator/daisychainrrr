# deletion-not-rewarded → tombstone-criteria

**Full path:** `01-ethos/down-to-the-bone/deletion-not-rewarded/tombstone-criteria`

## Purpose
Operational leaf for the `deletion-not-rewarded` eventuality: **tombstone-criteria**.
