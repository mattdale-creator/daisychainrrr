# deletion-not-rewarded → respond

**Full path:** `01-ethos/down-to-the-bone/deletion-not-rewarded/respond`

## Purpose
Operational leaf for the `deletion-not-rewarded` eventuality: **respond**.
