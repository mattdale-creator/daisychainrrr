# open-weights-only-called-ttllm → respond

**Full path:** `01-ethos/down-to-the-bone/open-weights-only-called-ttllm/respond`

## Purpose
Operational leaf for the `open-weights-only-called-ttllm` eventuality: **respond**.
