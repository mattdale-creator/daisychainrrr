# open-weights-only-called-ttllm → prevent

**Full path:** `01-ethos/down-to-the-bone/open-weights-only-called-ttllm/prevent`

## Purpose
Operational leaf for the `open-weights-only-called-ttllm` eventuality: **prevent**.
