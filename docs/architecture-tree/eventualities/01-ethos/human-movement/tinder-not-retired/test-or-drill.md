# tinder-not-retired → test-or-drill

**Full path:** `01-ethos/human-movement/tinder-not-retired/test-or-drill`

## Purpose
Operational leaf for the `tinder-not-retired` eventuality: **test-or-drill**.
