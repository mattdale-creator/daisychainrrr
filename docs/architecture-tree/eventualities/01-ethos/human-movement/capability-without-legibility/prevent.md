# capability-without-legibility → prevent

**Full path:** `01-ethos/human-movement/capability-without-legibility/prevent`

## Purpose
Operational leaf for the `capability-without-legibility` eventuality: **prevent**.
