# capability-without-legibility → detect

**Full path:** `01-ethos/human-movement/capability-without-legibility/detect`

## Purpose
Operational leaf for the `capability-without-legibility` eventuality: **detect**.
