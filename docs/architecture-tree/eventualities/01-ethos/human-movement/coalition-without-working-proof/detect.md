# coalition-without-working-proof → detect

**Full path:** `01-ethos/human-movement/coalition-without-working-proof/detect`

## Purpose
Operational leaf for the `coalition-without-working-proof` eventuality: **detect**.
