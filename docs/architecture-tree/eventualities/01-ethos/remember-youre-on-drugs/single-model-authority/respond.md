# single-model-authority → respond

**Full path:** `01-ethos/remember-youre-on-drugs/single-model-authority/respond`

## Purpose
Operational leaf for the `single-model-authority` eventuality: **respond**.
