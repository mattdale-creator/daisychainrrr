# single-model-authority → prevent

**Full path:** `01-ethos/remember-youre-on-drugs/single-model-authority/prevent`

## Purpose
Operational leaf for the `single-model-authority` eventuality: **prevent**.
