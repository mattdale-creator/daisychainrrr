# single-model-authority → test-or-drill

**Full path:** `01-ethos/remember-youre-on-drugs/single-model-authority/test-or-drill`

## Purpose
Operational leaf for the `single-model-authority` eventuality: **test-or-drill**.
