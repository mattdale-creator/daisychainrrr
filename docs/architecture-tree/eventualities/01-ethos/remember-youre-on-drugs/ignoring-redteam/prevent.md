# ignoring-redteam → prevent

**Full path:** `01-ethos/remember-youre-on-drugs/ignoring-redteam/prevent`

## Purpose
Operational leaf for the `ignoring-redteam` eventuality: **prevent**.
