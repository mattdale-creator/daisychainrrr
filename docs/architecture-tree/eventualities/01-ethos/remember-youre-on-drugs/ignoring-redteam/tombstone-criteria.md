# ignoring-redteam → tombstone-criteria

**Full path:** `01-ethos/remember-youre-on-drugs/ignoring-redteam/tombstone-criteria`

## Purpose
Operational leaf for the `ignoring-redteam` eventuality: **tombstone-criteria**.
