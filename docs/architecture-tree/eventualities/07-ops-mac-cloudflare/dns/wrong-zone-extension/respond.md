# wrong-zone-extension → respond

**Full path:** `07-ops-mac-cloudflare/dns/wrong-zone-extension/respond`

## Purpose
Operational leaf for the `wrong-zone-extension` eventuality: **respond**.
