# wrong-zone-extension → detect

**Full path:** `07-ops-mac-cloudflare/dns/wrong-zone-extension/detect`

## Purpose
Operational leaf for the `wrong-zone-extension` eventuality: **detect**.
