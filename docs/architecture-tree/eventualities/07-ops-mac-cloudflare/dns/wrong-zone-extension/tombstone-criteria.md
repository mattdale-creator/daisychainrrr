# wrong-zone-extension → tombstone-criteria

**Full path:** `07-ops-mac-cloudflare/dns/wrong-zone-extension/tombstone-criteria`

## Purpose
Operational leaf for the `wrong-zone-extension` eventuality: **tombstone-criteria**.
