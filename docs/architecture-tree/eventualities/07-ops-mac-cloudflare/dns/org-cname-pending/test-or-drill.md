# org-cname-pending → test-or-drill

**Full path:** `07-ops-mac-cloudflare/dns/org-cname-pending/test-or-drill`

## Purpose
Operational leaf for the `org-cname-pending` eventuality: **test-or-drill**.
