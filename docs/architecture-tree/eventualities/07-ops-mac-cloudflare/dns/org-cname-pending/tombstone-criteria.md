# org-cname-pending → tombstone-criteria

**Full path:** `07-ops-mac-cloudflare/dns/org-cname-pending/tombstone-criteria`

## Purpose
Operational leaf for the `org-cname-pending` eventuality: **tombstone-criteria**.
