# local-nxdomain-trap → prevent

**Full path:** `07-ops-mac-cloudflare/dns/local-nxdomain-trap/prevent`

## Purpose
Operational leaf for the `local-nxdomain-trap` eventuality: **prevent**.
