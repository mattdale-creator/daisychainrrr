# local-nxdomain-trap → test-or-drill

**Full path:** `07-ops-mac-cloudflare/dns/local-nxdomain-trap/test-or-drill`

## Purpose
Operational leaf for the `local-nxdomain-trap` eventuality: **test-or-drill**.
