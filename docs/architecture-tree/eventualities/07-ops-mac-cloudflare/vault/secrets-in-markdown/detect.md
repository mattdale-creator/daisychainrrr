# secrets-in-markdown → detect

**Full path:** `07-ops-mac-cloudflare/vault/secrets-in-markdown/detect`

## Purpose
Operational leaf for the `secrets-in-markdown` eventuality: **detect**.
