# secrets-in-markdown → test-or-drill

**Full path:** `07-ops-mac-cloudflare/vault/secrets-in-markdown/test-or-drill`

## Purpose
Operational leaf for the `secrets-in-markdown` eventuality: **test-or-drill**.
