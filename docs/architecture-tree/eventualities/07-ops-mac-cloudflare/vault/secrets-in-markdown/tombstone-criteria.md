# secrets-in-markdown → tombstone-criteria

**Full path:** `07-ops-mac-cloudflare/vault/secrets-in-markdown/tombstone-criteria`

## Purpose
Operational leaf for the `secrets-in-markdown` eventuality: **tombstone-criteria**.
