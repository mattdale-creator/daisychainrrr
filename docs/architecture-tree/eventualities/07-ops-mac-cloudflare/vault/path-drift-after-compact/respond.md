# path-drift-after-compact → respond

**Full path:** `07-ops-mac-cloudflare/vault/path-drift-after-compact/respond`

## Purpose
Operational leaf for the `path-drift-after-compact` eventuality: **respond**.
