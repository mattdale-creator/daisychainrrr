# path-drift-after-compact → detect

**Full path:** `07-ops-mac-cloudflare/vault/path-drift-after-compact/detect`

## Purpose
Operational leaf for the `path-drift-after-compact` eventuality: **detect**.
