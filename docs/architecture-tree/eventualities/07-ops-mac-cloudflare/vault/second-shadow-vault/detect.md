# second-shadow-vault → detect

**Full path:** `07-ops-mac-cloudflare/vault/second-shadow-vault/detect`

## Purpose
Operational leaf for the `second-shadow-vault` eventuality: **detect**.
