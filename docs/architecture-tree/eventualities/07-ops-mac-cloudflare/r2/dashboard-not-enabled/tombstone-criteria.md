# dashboard-not-enabled → tombstone-criteria

**Full path:** `07-ops-mac-cloudflare/r2/dashboard-not-enabled/tombstone-criteria`

## Purpose
Operational leaf for the `dashboard-not-enabled` eventuality: **tombstone-criteria**.
