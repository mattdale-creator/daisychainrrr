# dashboard-not-enabled → test-or-drill

**Full path:** `07-ops-mac-cloudflare/r2/dashboard-not-enabled/test-or-drill`

## Purpose
Operational leaf for the `dashboard-not-enabled` eventuality: **test-or-drill**.
