# dashboard-not-enabled → detect

**Full path:** `07-ops-mac-cloudflare/r2/dashboard-not-enabled/detect`

## Purpose
Operational leaf for the `dashboard-not-enabled` eventuality: **detect**.
