# dashboard-not-enabled → prevent

**Full path:** `07-ops-mac-cloudflare/r2/dashboard-not-enabled/prevent`

## Purpose
Operational leaf for the `dashboard-not-enabled` eventuality: **prevent**.
