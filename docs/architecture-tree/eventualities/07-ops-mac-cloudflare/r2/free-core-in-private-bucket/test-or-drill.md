# free-core-in-private-bucket → test-or-drill

**Full path:** `07-ops-mac-cloudflare/r2/free-core-in-private-bucket/test-or-drill`

## Purpose
Operational leaf for the `free-core-in-private-bucket` eventuality: **test-or-drill**.
