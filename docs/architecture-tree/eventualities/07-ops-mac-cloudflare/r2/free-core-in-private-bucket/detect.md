# free-core-in-private-bucket → detect

**Full path:** `07-ops-mac-cloudflare/r2/free-core-in-private-bucket/detect`

## Purpose
Operational leaf for the `free-core-in-private-bucket` eventuality: **detect**.
