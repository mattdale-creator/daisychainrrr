# free-core-in-private-bucket → prevent

**Full path:** `07-ops-mac-cloudflare/r2/free-core-in-private-bucket/prevent`

## Purpose
Operational leaf for the `free-core-in-private-bucket` eventuality: **prevent**.
