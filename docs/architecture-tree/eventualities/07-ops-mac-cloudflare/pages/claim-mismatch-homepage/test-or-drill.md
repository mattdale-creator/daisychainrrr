# claim-mismatch-homepage → test-or-drill

**Full path:** `07-ops-mac-cloudflare/pages/claim-mismatch-homepage/test-or-drill`

## Purpose
Operational leaf for the `claim-mismatch-homepage` eventuality: **test-or-drill**.
