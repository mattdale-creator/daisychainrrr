# claim-mismatch-homepage → respond

**Full path:** `07-ops-mac-cloudflare/pages/claim-mismatch-homepage/respond`

## Purpose
Operational leaf for the `claim-mismatch-homepage` eventuality: **respond**.
