# handoff-spawn-without-consent → test-or-drill

**Full path:** `07-ops-mac-cloudflare/precompact/handoff-spawn-without-consent/test-or-drill`

## Purpose
Operational leaf for the `handoff-spawn-without-consent` eventuality: **test-or-drill**.
