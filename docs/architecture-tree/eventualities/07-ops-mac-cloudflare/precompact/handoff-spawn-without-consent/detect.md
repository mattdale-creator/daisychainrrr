# handoff-spawn-without-consent → detect

**Full path:** `07-ops-mac-cloudflare/precompact/handoff-spawn-without-consent/detect`

## Purpose
Operational leaf for the `handoff-spawn-without-consent` eventuality: **detect**.
