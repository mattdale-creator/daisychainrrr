# freeze-without-read → test-or-drill

**Full path:** `07-ops-mac-cloudflare/precompact/freeze-without-read/test-or-drill`

## Purpose
Operational leaf for the `freeze-without-read` eventuality: **test-or-drill**.
