# freeze-without-read → tombstone-criteria

**Full path:** `07-ops-mac-cloudflare/precompact/freeze-without-read/tombstone-criteria`

## Purpose
Operational leaf for the `freeze-without-read` eventuality: **tombstone-criteria**.
