# freeze-without-read → detect

**Full path:** `07-ops-mac-cloudflare/precompact/freeze-without-read/detect`

## Purpose
Operational leaf for the `freeze-without-read` eventuality: **detect**.
