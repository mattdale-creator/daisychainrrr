# seed-not-logged → test-or-drill

**Full path:** `08-nano-release/repro/seed-not-logged/test-or-drill`

## Purpose
Operational leaf for the `seed-not-logged` eventuality: **test-or-drill**.
