# data-url-fetch-fail → test-or-drill

**Full path:** `08-nano-release/repro/data-url-fetch-fail/test-or-drill`

## Purpose
Operational leaf for the `data-url-fetch-fail` eventuality: **test-or-drill**.
