# data-url-fetch-fail → tombstone-criteria

**Full path:** `08-nano-release/repro/data-url-fetch-fail/tombstone-criteria`

## Purpose
Operational leaf for the `data-url-fetch-fail` eventuality: **tombstone-criteria**.
