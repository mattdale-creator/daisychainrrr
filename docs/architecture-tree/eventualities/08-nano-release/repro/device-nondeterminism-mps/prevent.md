# device-nondeterminism-mps → prevent

**Full path:** `08-nano-release/repro/device-nondeterminism-mps/prevent`

## Purpose
Operational leaf for the `device-nondeterminism-mps` eventuality: **prevent**.
