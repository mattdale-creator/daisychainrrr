# device-nondeterminism-mps → tombstone-criteria

**Full path:** `08-nano-release/repro/device-nondeterminism-mps/tombstone-criteria`

## Purpose
Operational leaf for the `device-nondeterminism-mps` eventuality: **tombstone-criteria**.
