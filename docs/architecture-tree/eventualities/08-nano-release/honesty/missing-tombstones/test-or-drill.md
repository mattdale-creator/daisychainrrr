# missing-tombstones → test-or-drill

**Full path:** `08-nano-release/honesty/missing-tombstones/test-or-drill`

## Purpose
Operational leaf for the `missing-tombstones` eventuality: **test-or-drill**.
