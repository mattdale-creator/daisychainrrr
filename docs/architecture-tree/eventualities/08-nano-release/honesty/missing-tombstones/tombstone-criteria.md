# missing-tombstones → tombstone-criteria

**Full path:** `08-nano-release/honesty/missing-tombstones/tombstone-criteria`

## Purpose
Operational leaf for the `missing-tombstones` eventuality: **tombstone-criteria**.
