# nano-sold-as-olmo-scale → detect

**Full path:** `08-nano-release/honesty/nano-sold-as-olmo-scale/detect`

## Purpose
Operational leaf for the `nano-sold-as-olmo-scale` eventuality: **detect**.
