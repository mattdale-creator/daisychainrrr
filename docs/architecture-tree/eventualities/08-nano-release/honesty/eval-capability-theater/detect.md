# eval-capability-theater → detect

**Full path:** `08-nano-release/honesty/eval-capability-theater/detect`

## Purpose
Operational leaf for the `eval-capability-theater` eventuality: **detect**.
