# eval-capability-theater → respond

**Full path:** `08-nano-release/honesty/eval-capability-theater/respond`

## Purpose
Operational leaf for the `eval-capability-theater` eventuality: **respond**.
