# corrupt-pt → tombstone-criteria

**Full path:** `08-nano-release/checkpoints/corrupt-pt/tombstone-criteria`

## Purpose
Operational leaf for the `corrupt-pt` eventuality: **tombstone-criteria**.
