# hyperparams-missing → tombstone-criteria

**Full path:** `08-nano-release/checkpoints/hyperparams-missing/tombstone-criteria`

## Purpose
Operational leaf for the `hyperparams-missing` eventuality: **tombstone-criteria**.
