# checkpoints · test-or-drill

**Path:** `eventualities/08-nano-release/checkpoints/hyperparams-missing/test-or-drill.md`  
**Updated:** 2026-08-08  
**Leaf type:** test-or-drill — test or tabletop drill

## Purpose
Test or tabletop drill for: **checkpoints** · failure · phase before public release or claim · actor project lead / founder.
