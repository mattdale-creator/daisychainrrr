# hyperparams-missing → respond

**Full path:** `08-nano-release/checkpoints/hyperparams-missing/respond`

## Purpose
Operational leaf for the `hyperparams-missing` eventuality: **respond**.
