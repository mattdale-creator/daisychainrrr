...
**Path:** `eventualities/08-nano-release/checkpoints/hyperparams-missing/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: **checkpoints** · failure · phase before public release or claim · actor project lead / founder.
...
## Output of detection
Write a one-paragraph incident/note with: path `08-nano-release/checkpoints/hyperparams-missing/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
