# only-final-saved → test-or-drill

**Full path:** `08-nano-release/checkpoints/only-final-saved/test-or-drill`

## Purpose
Operational leaf for the `only-final-saved` eventuality: **test-or-drill**.
