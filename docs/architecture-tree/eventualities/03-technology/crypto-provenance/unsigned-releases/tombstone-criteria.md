# unsigned-releases → tombstone-criteria

**Full path:** `03-technology/crypto-provenance/unsigned-releases/tombstone-criteria`

## Purpose
Operational leaf for the `unsigned-releases` eventuality: **tombstone-criteria**.
