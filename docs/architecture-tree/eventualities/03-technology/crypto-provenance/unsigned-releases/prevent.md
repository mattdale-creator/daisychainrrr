# unsigned-releases → prevent

**Full path:** `03-technology/crypto-provenance/unsigned-releases/prevent`

## Purpose
Operational leaf for the `unsigned-releases` eventuality: **prevent**.
