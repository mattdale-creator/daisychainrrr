# unsigned-releases → respond

**Full path:** `03-technology/crypto-provenance/unsigned-releases/respond`

## Purpose
Operational leaf for the `unsigned-releases` eventuality: **respond**.
