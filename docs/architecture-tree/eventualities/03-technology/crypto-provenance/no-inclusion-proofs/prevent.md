# no-inclusion-proofs → prevent

**Full path:** `03-technology/crypto-provenance/no-inclusion-proofs/prevent`

## Purpose
Operational leaf for the `no-inclusion-proofs` eventuality: **prevent**.
