# no-inclusion-proofs → test-or-drill

**Full path:** `03-technology/crypto-provenance/no-inclusion-proofs/test-or-drill`

## Purpose
Operational leaf for the `no-inclusion-proofs` eventuality: **test-or-drill**.
