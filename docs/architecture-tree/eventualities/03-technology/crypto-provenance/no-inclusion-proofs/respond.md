# no-inclusion-proofs → respond

**Full path:** `03-technology/crypto-provenance/no-inclusion-proofs/respond`

## Purpose
Operational leaf for the `no-inclusion-proofs` eventuality: **respond**.
