# no-inclusion-proofs → detect

**Full path:** `03-technology/crypto-provenance/no-inclusion-proofs/detect`

## Purpose
Operational leaf for the `no-inclusion-proofs` eventuality: **detect**.
