# no-inclusion-proofs → tombstone-criteria

**Full path:** `03-technology/crypto-provenance/no-inclusion-proofs/tombstone-criteria`

## Purpose
Operational leaf for the `no-inclusion-proofs` eventuality: **tombstone-criteria**.
