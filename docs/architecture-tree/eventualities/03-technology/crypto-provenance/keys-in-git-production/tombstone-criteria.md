# keys-in-git-production → tombstone-criteria

**Full path:** `03-technology/crypto-provenance/keys-in-git-production/tombstone-criteria`

## Purpose
Operational leaf for the `keys-in-git-production` eventuality: **tombstone-criteria**.
