# 03-technology/crypto-provenance/keys-in-git-production/test-or-drill.md · test-or-drill

**Path:** `eventualities/03-technology/crypto-provenance/keys-in-git-production/test-or-drill.md`  
**Updated:** 2026-08-08  
