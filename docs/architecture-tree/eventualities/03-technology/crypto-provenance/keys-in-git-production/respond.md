# keys-in-git-production → respond

**Full path:** `03-technology/crypto-provenance/keys-in-git-production/respond`

## Purpose
Operational leaf for the `keys-in-git-production` eventuality: **respond**.
