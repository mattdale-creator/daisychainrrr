# demo-keys-as-root-of-trust → test-or-drill

**Full path:** `03-technology/crypto-provenance/demo-keys-as-root-of-trust/test-or-drill`

## Purpose
Operational leaf for the `demo-keys-as-root-of-trust` eventuality: **test-or-drill**.
