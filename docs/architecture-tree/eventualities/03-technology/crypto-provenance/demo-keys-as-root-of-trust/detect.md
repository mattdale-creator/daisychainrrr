# demo-keys-as-root-of-trust → detect

**Full path:** `03-technology/crypto-provenance/demo-keys-as-root-of-trust/detect`

## Purpose
Operational leaf for the `demo-keys-as-root-of-trust` eventuality: **detect**.
