# demo-keys-as-root-of-trust → respond

**Full path:** `03-technology/crypto-provenance/demo-keys-as-root-of-trust/respond`

## Purpose
Operational leaf for the `demo-keys-as-root-of-trust` eventuality: **respond**.
