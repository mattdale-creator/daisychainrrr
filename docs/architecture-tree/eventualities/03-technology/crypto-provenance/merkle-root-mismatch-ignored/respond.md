# merkle-root-mismatch-ignored → respond

**Full path:** `03-technology/crypto-provenance/merkle-root-mismatch-ignored/respond`

## Purpose
Operational leaf for the `merkle-root-mismatch-ignored` eventuality: **respond**.
