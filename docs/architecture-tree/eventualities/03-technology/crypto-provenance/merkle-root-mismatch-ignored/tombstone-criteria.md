# merkle-root-mismatch-ignored → tombstone-criteria

**Full path:** `03-technology/crypto-provenance/merkle-root-mismatch-ignored/tombstone-criteria`

## Purpose
Operational leaf for the `merkle-root-mismatch-ignored` eventuality: **tombstone-criteria**.
