# merkle-root-mismatch-ignored → prevent

**Full path:** `03-technology/crypto-provenance/merkle-root-mismatch-ignored/prevent`

## Purpose
Operational leaf for the `merkle-root-mismatch-ignored` eventuality: **prevent**.
