# secret-training-code → test-or-drill

**Full path:** `03-technology/training/secret-training-code/test-or-drill`

## Purpose
Operational leaf for the `secret-training-code` eventuality: **test-or-drill**.
