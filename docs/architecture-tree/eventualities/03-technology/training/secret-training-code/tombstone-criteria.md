# secret-training-code → tombstone-criteria

**Full path:** `03-technology/training/secret-training-code/tombstone-criteria`

## Purpose
Operational leaf for the `secret-training-code` eventuality: **tombstone-criteria**.
