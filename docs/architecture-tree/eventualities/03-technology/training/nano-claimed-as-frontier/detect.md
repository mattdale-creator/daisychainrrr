# nano-claimed-as-frontier → detect

**Full path:** `03-technology/training/nano-claimed-as-frontier/detect`

## Purpose
Operational leaf for the `nano-claimed-as-frontier` eventuality: **detect**.
