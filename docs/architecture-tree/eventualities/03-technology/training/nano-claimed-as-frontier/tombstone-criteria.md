# nano-claimed-as-frontier → tombstone-criteria

**Full path:** `03-technology/training/nano-claimed-as-frontier/tombstone-criteria`

## Purpose
Operational leaf for the `nano-claimed-as-frontier` eventuality: **tombstone-criteria**.
