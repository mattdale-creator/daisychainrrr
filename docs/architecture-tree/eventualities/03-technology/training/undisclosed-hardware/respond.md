# undisclosed-hardware → respond

**Full path:** `03-technology/training/undisclosed-hardware/respond`

## Purpose
Operational leaf for the `undisclosed-hardware` eventuality: **respond**.
