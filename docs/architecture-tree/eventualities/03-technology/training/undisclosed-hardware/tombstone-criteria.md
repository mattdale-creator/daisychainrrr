# undisclosed-hardware → tombstone-criteria

**Full path:** `03-technology/training/undisclosed-hardware/tombstone-criteria`

## Purpose
Operational leaf for the `undisclosed-hardware` eventuality: **tombstone-criteria**.
