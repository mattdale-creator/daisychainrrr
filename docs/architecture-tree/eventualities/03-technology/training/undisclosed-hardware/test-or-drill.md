# undisclosed-hardware → test-or-drill

**Full path:** `03-technology/training/undisclosed-hardware/test-or-drill`

## Purpose
Operational leaf for the `undisclosed-hardware` eventuality: **test-or-drill**.
