# undisclosed-hardware → detect

**Full path:** `03-technology/training/undisclosed-hardware/detect`

## Purpose
Operational leaf for the `undisclosed-hardware` eventuality: **detect**.
