# unlogged-seeds → tombstone-criteria

**Full path:** `03-technology/training/unlogged-seeds/tombstone-criteria`

## Purpose
Operational leaf for the `unlogged-seeds` eventuality: **tombstone-criteria**.
