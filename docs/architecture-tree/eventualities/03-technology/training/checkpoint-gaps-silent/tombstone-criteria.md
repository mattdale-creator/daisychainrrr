# checkpoint-gaps-silent → tombstone-criteria

**Full path:** `03-technology/training/checkpoint-gaps-silent/tombstone-criteria`

## Purpose
Operational leaf for the `checkpoint-gaps-silent` eventuality: **tombstone-criteria**.
