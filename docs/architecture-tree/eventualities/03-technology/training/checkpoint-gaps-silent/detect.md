# checkpoint-gaps-silent → detect

**Full path:** `03-technology/training/checkpoint-gaps-silent/detect`

## Purpose
Operational leaf for the `checkpoint-gaps-silent` eventuality: **detect**.
