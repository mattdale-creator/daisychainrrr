# gutenberg-header-not-stripped → prevent

**Full path:** `03-technology/data-release/gutenberg-header-not-stripped/prevent`

## Purpose
Operational leaf for the `gutenberg-header-not-stripped` eventuality: **prevent**.
