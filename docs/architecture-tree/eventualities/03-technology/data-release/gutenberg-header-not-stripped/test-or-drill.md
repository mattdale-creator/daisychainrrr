# gutenberg-header-not-stripped → test-or-drill

**Full path:** `03-technology/data-release/gutenberg-header-not-stripped/test-or-drill`

## Purpose
Operational leaf for the `gutenberg-header-not-stripped` eventuality: **test-or-drill**.
