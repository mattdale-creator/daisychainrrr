# gutenberg-header-not-stripped → detect

**Full path:** `03-technology/data-release/gutenberg-header-not-stripped/detect`

## Purpose
Operational leaf for the `gutenberg-header-not-stripped` eventuality: **detect**.
