# pii-without-process → detect

**Full path:** `03-technology/data-release/pii-without-process/detect`

## Purpose
Operational leaf for the `pii-without-process` eventuality: **detect**.
