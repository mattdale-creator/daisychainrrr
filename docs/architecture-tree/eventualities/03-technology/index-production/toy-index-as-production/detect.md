# toy-index-as-production → detect

**Full path:** `03-technology/index-production/toy-index-as-production/detect`

## Purpose
Operational leaf for the `toy-index-as-production` eventuality: **detect**.
