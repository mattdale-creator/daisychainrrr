# no-canaries → test-or-drill

**Full path:** `03-technology/index-production/no-canaries/test-or-drill`

## Purpose
Operational leaf for the `no-canaries` eventuality: **test-or-drill**.
