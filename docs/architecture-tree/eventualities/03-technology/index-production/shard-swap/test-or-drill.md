# shard-swap → test-or-drill

**Full path:** `03-technology/index-production/shard-swap/test-or-drill`

## Purpose
Operational leaf for the `shard-swap` eventuality: **test-or-drill**.
