# shard-swap → tombstone-criteria

**Full path:** `03-technology/index-production/shard-swap/tombstone-criteria`

## Purpose
Operational leaf for the `shard-swap` eventuality: **tombstone-criteria**.
