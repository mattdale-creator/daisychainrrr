# 03-technology/training-pipeline-deep/hyperparams-disagree-with-ckpt/scorecard-impact.md · scorecard-impact

**Path:** `eventualities/03-technology/training-pipeline-deep/hyperparams-disagree-with-ckpt/scorecard-impact.md`  
**Updated:** 2026-08-08  
**Leaf type:** scorecard-impact — scorecard row impact

## Purpose
Scorecard row impact for: **component** · failure · phase before public release or claim · actor project lead / founder.
