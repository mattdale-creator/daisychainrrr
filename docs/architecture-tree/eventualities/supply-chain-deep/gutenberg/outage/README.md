# Supply chain · gutenberg · outage

**Path:** `eventualities/supply-chain-deep/gutenberg/outage/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **gutenberg** experiences: **provider or system unavailable**.
