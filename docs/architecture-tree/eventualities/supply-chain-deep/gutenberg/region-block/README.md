# Supply chain · gutenberg · region-block

**Path:** `eventualities/supply-chain-deep/gutenberg/region-block/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **gutenberg** experiences: **geo or policy restriction blocks access**.
