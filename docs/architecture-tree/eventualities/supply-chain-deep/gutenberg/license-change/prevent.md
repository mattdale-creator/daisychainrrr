# license-change · gutenberg · prevent

**Path:** `eventualities/supply-chain-deep/gutenberg/license-change/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Supply dependency **gutenberg** risk **license of dependency or data source changed**.
