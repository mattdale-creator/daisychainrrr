# outage · apple-silicon · test

**Path:** `eventualities/supply-chain-deep/apple-silicon/outage/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **apple-silicon** risk **provider or system unavailable**.
...
1. Assume **provider or system unavailable** occurs in phase **before public release or claim** with actor **project lead / founder**.
