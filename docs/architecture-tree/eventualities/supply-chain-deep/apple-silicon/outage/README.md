# Supply chain · apple-silicon · outage

**Path:** `eventualities/supply-chain-deep/apple-silicon/outage/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **apple-silicon** experiences: **provider or system unavailable**.
