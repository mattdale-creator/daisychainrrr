# terms-change · apple-silicon · test

**Path:** `eventualities/supply-chain-deep/apple-silicon/terms-change/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **apple-silicon** risk **upstream terms/license/policy changed adversely**.
...
1. Assume **upstream terms/license/policy changed adversely** occurs in phase **before public release or claim** with actor **project lead / founder**.
