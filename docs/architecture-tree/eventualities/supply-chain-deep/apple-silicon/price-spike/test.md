# price-spike · apple-silicon · test

**Path:** `eventualities/supply-chain-deep/apple-silicon/price-spike/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **apple-silicon** risk **cost change threatens free-core hosting**.
...
1. Assume **cost change threatens free-core hosting** occurs in phase **before public release or claim** with actor **project lead / founder**.
