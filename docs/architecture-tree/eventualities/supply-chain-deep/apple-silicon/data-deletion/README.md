# Supply chain · apple-silicon · data-deletion

**Path:** `eventualities/supply-chain-deep/apple-silicon/data-deletion/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **apple-silicon** experiences: **upstream or local data was deleted**.
