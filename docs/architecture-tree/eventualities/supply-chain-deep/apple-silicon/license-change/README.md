# Supply chain · apple-silicon · license-change

**Path:** `eventualities/supply-chain-deep/apple-silicon/license-change/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **apple-silicon** experiences: **license of dependency or data source changed**.

## Dependency register
See `registers/supply-chain/DEPENDENCY_REGISTER.md`.  
apple-silicon is listed as part of public core hosting, training, data, or tooling.
...
## Owner
Project lead + whoever holds the apple-silicon account.  
