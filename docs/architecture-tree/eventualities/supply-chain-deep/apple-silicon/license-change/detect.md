# license-change · apple-silicon · detect

**Path:** `eventualities/supply-chain-deep/apple-silicon/license-change/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **apple-silicon** risk **license of dependency or data source changed**.
...
3. Compare published claims (site, README, scorecard) to artefacts under `registers/supply-chain/DEPENDENCY_REGISTER.md`.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/apple-silicon/license-change/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
