# license-change · apple-silicon · test

**Path:** `eventualities/supply-chain-deep/apple-silicon/license-change/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **apple-silicon** risk **license of dependency or data source changed**.
...
1. Assume **license of dependency or data source changed** occurs in phase **before public release or claim** with actor **project lead / founder**.
