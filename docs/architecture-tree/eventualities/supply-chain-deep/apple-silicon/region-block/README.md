# Supply chain · apple-silicon · region-block

**Path:** `eventualities/supply-chain-deep/apple-silicon/region-block/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **apple-silicon** experiences: **geo or policy restriction blocks access**.
