# price-spike · pytorch · test

**Path:** `eventualities/supply-chain-deep/pytorch/price-spike/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **pytorch** risk **cost change threatens free-core hosting**.
