# license-change · pytorch · detect

**Path:** `eventualities/supply-chain-deep/pytorch/license-change/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **pytorch** risk **license of dependency or data source changed**.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/pytorch/license-change/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
