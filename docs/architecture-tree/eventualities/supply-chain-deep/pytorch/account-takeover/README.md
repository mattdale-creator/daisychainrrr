# Supply chain · pytorch · account-takeover

**Path:** `eventualities/supply-chain-deep/pytorch/account-takeover/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **pytorch** experiences: **credential or account compromise risk**.
