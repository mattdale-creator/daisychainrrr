# Supply chain · pytorch · region-block

**Path:** `eventualities/supply-chain-deep/pytorch/region-block/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **pytorch** experiences: **geo or policy restriction blocks access**.
