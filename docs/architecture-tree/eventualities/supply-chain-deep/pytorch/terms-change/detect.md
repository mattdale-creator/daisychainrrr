# terms-change · pytorch · detect

**Path:** `eventualities/supply-chain-deep/pytorch/terms-change/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **pytorch** risk **upstream terms/license/policy changed adversely**.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/pytorch/terms-change/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
