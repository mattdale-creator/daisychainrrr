# terms-change · github · test

**Path:** `eventualities/supply-chain-deep/github/terms-change/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **github** risk **upstream terms/license/policy changed adversely**.
