# region-block · github · test

**Path:** `eventualities/supply-chain-deep/github/region-block/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **github** risk **geo or policy restriction blocks access**.
