# region-block · github · prevent

**Path:** `eventualities/supply-chain-deep/github/region-block/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Supply dependency **github** risk **geo or policy restriction blocks access**.
