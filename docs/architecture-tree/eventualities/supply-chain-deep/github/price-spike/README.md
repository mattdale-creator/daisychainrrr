# Supply chain · github · price-spike

**Path:** `eventualities/supply-chain-deep/github/price-spike/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **github** experiences: **cost change threatens free-core hosting**.
