# price-spike · github · prevent

**Path:** `eventualities/supply-chain-deep/github/price-spike/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Supply dependency **github** risk **cost change threatens free-core hosting**.
