# account-takeover · github · detect

**Path:** `eventualities/supply-chain-deep/github/account-takeover/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **github** risk **credential or account compromise risk**.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/github/account-takeover/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
