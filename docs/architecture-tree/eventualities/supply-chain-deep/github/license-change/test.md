# license-change · github · test

**Path:** `eventualities/supply-chain-deep/github/license-change/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **github** risk **license of dependency or data source changed**.
