# Supply chain · github · license-change

**Path:** `eventualities/supply-chain-deep/github/license-change/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **github** experiences: **license of dependency or data source changed**.

## Dependency register
See `registers/supply-chain/DEPENDENCY_REGISTER.md`.  
github is listed as part of public core hosting, training, data, or tooling.
...
## Owner
Project lead + whoever holds the github account.  
