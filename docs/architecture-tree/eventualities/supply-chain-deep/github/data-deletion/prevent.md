# data-deletion · github · prevent

**Path:** `eventualities/supply-chain-deep/github/data-deletion/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Supply dependency **github** risk **upstream or local data was deleted**.
