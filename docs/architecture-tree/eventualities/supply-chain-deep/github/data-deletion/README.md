# Supply chain · github · data-deletion

**Path:** `eventualities/supply-chain-deep/github/data-deletion/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **github** experiences: **upstream or local data was deleted**.
