# outage · cloudflare · test

**Path:** `eventualities/supply-chain-deep/cloudflare/outage/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **cloudflare** risk **provider or system unavailable**.
