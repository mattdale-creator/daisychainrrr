# Supply chain · cloudflare · license-change

**Path:** `eventualities/supply-chain-deep/cloudflare/license-change/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **cloudflare** experiences: **license of dependency or data source changed**.

## Dependency register
See `registers/supply-chain/DEPENDENCY_REGISTER.md`.  
cloudflare is listed as part of public core hosting, training, data, or tooling.
...
## Owner
Project lead + whoever holds the cloudflare account.  
