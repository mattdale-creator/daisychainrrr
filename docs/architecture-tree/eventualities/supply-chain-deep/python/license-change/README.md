# Supply chain · python · license-change

**Path:** `eventualities/supply-chain-deep/python/license-change/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **python** experiences: **license of dependency or data source changed**.
