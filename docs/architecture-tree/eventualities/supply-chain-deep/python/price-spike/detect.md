# price-spike · python · detect

**Path:** `eventualities/supply-chain-deep/python/price-spike/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **python** risk **cost change threatens free-core hosting**.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/python/price-spike/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
