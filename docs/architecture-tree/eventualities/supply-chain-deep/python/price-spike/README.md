# Supply chain · python · price-spike

**Path:** `eventualities/supply-chain-deep/python/price-spike/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **python** experiences: **cost change threatens free-core hosting**.
