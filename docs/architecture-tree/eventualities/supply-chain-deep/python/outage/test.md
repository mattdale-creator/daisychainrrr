...
**Path:** `eventualities/supply-chain-deep/python/outage/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **python** risk **provider or system unavailable**.
