# Supply chain · python · outage

**Path:** `eventualities/supply-chain-deep/python/outage/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **python** experiences: **provider or system unavailable**.
