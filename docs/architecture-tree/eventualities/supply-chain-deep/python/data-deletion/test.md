# data-deletion · python · test

**Path:** `eventualities/supply-chain-deep/python/data-deletion/test.md`  
**Updated:** 2026-08-08  
**Leaf type:** test — how we verify the control works

## Purpose
How we verify the control works for: Supply dependency **python** risk **upstream or local data was deleted**.
