# region-block · python · detect

**Path:** `eventualities/supply-chain-deep/python/region-block/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Supply dependency **python** risk **geo or policy restriction blocks access**.
...
## Output of detection
Write a one-paragraph incident/note with: path `supply-chain-deep/python/region-block/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
