# Supply chain · python · region-block

**Path:** `eventualities/supply-chain-deep/python/region-block/README.md`  
**Updated:** 2026-08-08  
**Domain:** 7 (Supply-Chain and Dependency Transparency)

## What this eventuality is
Material dependency **python** experiences: **geo or policy restriction blocks access**.
