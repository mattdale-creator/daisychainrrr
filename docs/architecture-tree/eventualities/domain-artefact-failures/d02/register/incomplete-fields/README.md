# Domain 02 · register · incomplete-fields

**Path:** `eventualities/domain-artefact-failures/d02/register/incomplete-fields/README.md`  
**Updated:** 2026-08-08  
...
Here the **register** artefact is compromised by: **template or log exists but critical fields are empty**.
