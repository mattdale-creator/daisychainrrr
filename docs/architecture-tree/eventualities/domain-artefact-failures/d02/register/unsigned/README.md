# Domain 02 · register · unsigned

**Path:** `eventualities/domain-artefact-failures/d02/register/unsigned/README.md`  
**Updated:** 2026-08-08  
...
Here the **register** artefact is compromised by: **release or index lacks required signature or seal**.
