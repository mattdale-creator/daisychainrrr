# unsigned · d02 · charter · prevent

**Path:** `eventualities/domain-artefact-failures/d02/charter/unsigned/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 02 artefact **charter** under threat **release or index lacks required signature or seal**.
