# absent · d02 · charter · prevent

**Path:** `eventualities/domain-artefact-failures/d02/charter/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 02 artefact **charter** under threat **required domain artefact is not present**.
