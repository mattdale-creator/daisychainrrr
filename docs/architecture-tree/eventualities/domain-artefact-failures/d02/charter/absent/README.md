# Domain 02 · charter · absent

**Path:** `eventualities/domain-artefact-failures/d02/charter/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **charter** artefact is compromised by: **required domain artefact is not present**.
