# stale · d02 · report · prevent

**Path:** `eventualities/domain-artefact-failures/d02/report/stale/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 02 artefact **report** under threat **artefact exists but is outdated relative to current release**.
