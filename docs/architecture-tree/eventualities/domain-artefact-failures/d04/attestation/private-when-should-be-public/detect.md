# private-when-should-be-public · d04 · attestation · detect

**Path:** `eventualities/domain-artefact-failures/d04/attestation/private-when-should-be-public/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 04 artefact **attestation** under threat **Domain transparency artefact is hidden without logged exception**.
...
3. Compare published claims (site, README, scorecard) to artefacts under `docs/specs/artefacts/04/, docs/specs/04-*.md`.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d04/attestation/private-when-should-be-public/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
