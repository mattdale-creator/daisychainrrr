# stale · d04 · policy · prevent

**Path:** `eventualities/domain-artefact-failures/d04/policy/stale/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 04 artefact **policy** under threat **artefact exists but is outdated relative to current release**.
