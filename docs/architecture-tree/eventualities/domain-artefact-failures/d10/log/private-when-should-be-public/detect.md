# private-when-should-be-public · d10 · log · detect

**Path:** `eventualities/domain-artefact-failures/d10/log/private-when-should-be-public/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 10 artefact **log** under threat **Domain transparency artefact is hidden without logged exception**.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d10/log/private-when-should-be-public/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
