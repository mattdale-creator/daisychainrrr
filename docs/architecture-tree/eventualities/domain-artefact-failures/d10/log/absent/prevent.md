# absent · d10 · log · prevent

**Path:** `eventualities/domain-artefact-failures/d10/log/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 10 artefact **log** under threat **required domain artefact is not present**.
