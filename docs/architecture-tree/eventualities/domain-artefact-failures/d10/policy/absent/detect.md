# absent · d10 · policy · detect

**Path:** `eventualities/domain-artefact-failures/d10/policy/absent/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 10 artefact **policy** under threat **required domain artefact is not present**.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d10/policy/absent/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
