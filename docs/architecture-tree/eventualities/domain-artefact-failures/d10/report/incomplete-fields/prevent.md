# incomplete-fields · d10 · report · prevent

**Path:** `eventualities/domain-artefact-failures/d10/report/incomplete-fields/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 10 artefact **report** under threat **template or log exists but critical fields are empty**.
