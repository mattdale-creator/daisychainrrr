# Domain 05 · policy · private-when-should-be-public

**Path:** `eventualities/domain-artefact-failures/d05/policy/private-when-should-be-public/README.md`  
**Updated:** 2026-08-08  
...
Here the **policy** artefact is compromised by: **Domain transparency artefact is hidden without logged exception**.
