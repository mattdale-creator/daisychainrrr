# absent · d05 · policy · prevent

**Path:** `eventualities/domain-artefact-failures/d05/policy/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 05 artefact **policy** under threat **required domain artefact is not present**.
