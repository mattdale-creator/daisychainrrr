# contradicts-BOUNDARY · d05 · charter · detect

**Path:** `eventualities/domain-artefact-failures/d05/charter/contradicts-BOUNDARY/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 05 artefact **charter** under threat **practice or SKU contradicts commercial/BOUNDARY.md**.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d05/charter/contradicts-BOUNDARY/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
