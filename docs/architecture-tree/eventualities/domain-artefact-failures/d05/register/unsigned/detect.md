# unsigned · d05 · register · detect

**Path:** `eventualities/domain-artefact-failures/d05/register/unsigned/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 05 artefact **register** under threat **release or index lacks required signature or seal**.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d05/register/unsigned/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
