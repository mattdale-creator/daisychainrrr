# incomplete-fields · d05 · register · prevent

**Path:** `eventualities/domain-artefact-failures/d05/register/incomplete-fields/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 05 artefact **register** under threat **template or log exists but critical fields are empty**.
