# absent · d05 · report · prevent

**Path:** `eventualities/domain-artefact-failures/d05/report/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 05 artefact **report** under threat **required domain artefact is not present**.
