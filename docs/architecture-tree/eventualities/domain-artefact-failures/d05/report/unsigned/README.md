# Domain 05 · report · unsigned

**Path:** `eventualities/domain-artefact-failures/d05/report/unsigned/README.md`  
**Updated:** 2026-08-08  
...
Here the **report** artefact is compromised by: **release or index lacks required signature or seal**.
