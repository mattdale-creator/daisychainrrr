# absent · d09 · policy · prevent

**Path:** `eventualities/domain-artefact-failures/d09/policy/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 09 artefact **policy** under threat **required domain artefact is not present**.
