# absent · d03 · charter · prevent

**Path:** `eventualities/domain-artefact-failures/d03/charter/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 03 artefact **charter** under threat **required domain artefact is not present**.
