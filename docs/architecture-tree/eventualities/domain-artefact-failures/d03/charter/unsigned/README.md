# Domain 03 · charter · unsigned

**Path:** `eventualities/domain-artefact-failures/d03/charter/unsigned/README.md`  
**Updated:** 2026-08-08  
...
Here the **charter** artefact is compromised by: **release or index lacks required signature or seal**.
