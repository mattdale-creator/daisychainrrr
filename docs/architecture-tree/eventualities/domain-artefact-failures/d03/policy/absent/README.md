# Domain 03 · policy · absent

**Path:** `eventualities/domain-artefact-failures/d03/policy/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **policy** artefact is compromised by: **required domain artefact is not present**.
