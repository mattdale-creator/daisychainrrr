# Domain 03 · attestation · absent

**Path:** `eventualities/domain-artefact-failures/d03/attestation/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **attestation** artefact is compromised by: **required domain artefact is not present**.
