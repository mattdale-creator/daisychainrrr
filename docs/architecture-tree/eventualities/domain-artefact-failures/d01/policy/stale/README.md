# Domain 01 · policy · stale

**Path:** `eventualities/domain-artefact-failures/d01/policy/stale/README.md`  
**Updated:** 2026-08-08  
...
Here the **policy** artefact is compromised by: **artefact exists but is outdated relative to current release**.
