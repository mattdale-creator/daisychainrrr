# Domain 01 · policy · unsigned

**Path:** `eventualities/domain-artefact-failures/d01/policy/unsigned/README.md`  
**Updated:** 2026-08-08  
...
Here the **policy** artefact is compromised by: **release or index lacks required signature or seal**.
