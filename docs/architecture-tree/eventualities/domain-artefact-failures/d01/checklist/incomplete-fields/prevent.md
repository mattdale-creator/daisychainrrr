# incomplete-fields · d01 · checklist · prevent

**Path:** `eventualities/domain-artefact-failures/d01/checklist/incomplete-fields/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 01 artefact **checklist** under threat **template or log exists but critical fields are empty**.
