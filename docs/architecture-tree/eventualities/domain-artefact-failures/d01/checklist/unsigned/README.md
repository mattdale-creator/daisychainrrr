# Domain 01 · checklist · unsigned

**Path:** `eventualities/domain-artefact-failures/d01/checklist/unsigned/README.md`  
**Updated:** 2026-08-08  
...
Here the **checklist** artefact is compromised by: **release or index lacks required signature or seal**.
