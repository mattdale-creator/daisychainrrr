# incomplete-fields · d01 · report · prevent

**Path:** `eventualities/domain-artefact-failures/d01/report/incomplete-fields/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 01 artefact **report** under threat **template or log exists but critical fields are empty**.
