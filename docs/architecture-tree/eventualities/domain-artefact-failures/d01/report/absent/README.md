# Domain 01 · report · absent

**Path:** `eventualities/domain-artefact-failures/d01/report/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **report** artefact is compromised by: **required domain artefact is not present**.
