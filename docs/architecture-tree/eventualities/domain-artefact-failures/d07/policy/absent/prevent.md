# absent · d07 · policy · prevent

**Path:** `eventualities/domain-artefact-failures/d07/policy/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 07 artefact **policy** under threat **required domain artefact is not present**.
