# unsigned · d07 · report · detect

**Path:** `eventualities/domain-artefact-failures/d07/report/unsigned/detect.md`  
**Updated:** 2026-08-08  
**Leaf type:** detect — how we notice this failure mode early

## Purpose
How we notice this failure mode early for: Domain 07 artefact **report** under threat **release or index lacks required signature or seal**.
...
## Output of detection
Write a one-paragraph incident/note with: path `domain-artefact-failures/d07/report/unsigned/detect.md`, evidence command output, severity guess (Low–Critical per Domain 5 thresholds).
