...
**Path:** `eventualities/domain-artefact-failures/d07/log/stale/README.md`  
**Updated:** 2026-08-08  
...
Here the **log** artefact is compromised by: **artefact exists but is outdated relative to current release**.
