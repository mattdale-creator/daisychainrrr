# Domain 07 · log · incomplete-fields

**Path:** `eventualities/domain-artefact-failures/d07/log/incomplete-fields/README.md`  
**Updated:** 2026-08-08  
...
Here the **log** artefact is compromised by: **template or log exists but critical fields are empty**.
