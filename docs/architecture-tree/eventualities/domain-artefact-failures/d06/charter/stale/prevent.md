# stale · d06 · charter · prevent

**Path:** `eventualities/domain-artefact-failures/d06/charter/stale/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 06 artefact **charter** under threat **artefact exists but is outdated relative to current release**.
