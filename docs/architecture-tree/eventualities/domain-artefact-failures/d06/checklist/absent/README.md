# Domain 06 · checklist · absent

**Path:** `eventualities/domain-artefact-failures/d06/checklist/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **checklist** artefact is compromised by: **required domain artefact is not present**.
