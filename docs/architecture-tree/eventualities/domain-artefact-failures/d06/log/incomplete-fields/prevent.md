# incomplete-fields · d06 · log · prevent

**Path:** `eventualities/domain-artefact-failures/d06/log/incomplete-fields/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 06 artefact **log** under threat **template or log exists but critical fields are empty**.
