# Domain 06 · log · private-when-should-be-public

**Path:** `eventualities/domain-artefact-failures/d06/log/private-when-should-be-public/README.md`  
**Updated:** 2026-08-08  
...
Here the **log** artefact is compromised by: **Domain transparency artefact is hidden without logged exception**.
