# Domain 06 · log · absent

**Path:** `eventualities/domain-artefact-failures/d06/log/absent/README.md`  
**Updated:** 2026-08-08  
...
Here the **log** artefact is compromised by: **required domain artefact is not present**.
