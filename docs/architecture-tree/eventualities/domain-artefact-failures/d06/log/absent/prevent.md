# absent · d06 · log · prevent

**Path:** `eventualities/domain-artefact-failures/d06/log/absent/prevent.md`  
**Updated:** 2026-08-08  
**Leaf type:** prevent — controls that stop recurrence

## Purpose
Controls that stop recurrence for: Domain 06 artefact **log** under threat **required domain artefact is not present**.
