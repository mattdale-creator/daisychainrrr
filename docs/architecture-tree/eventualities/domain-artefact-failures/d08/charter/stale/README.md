# Domain 08 · charter · stale

**Path:** `eventualities/domain-artefact-failures/d08/charter/stale/README.md`  
**Updated:** 2026-08-08  
...
Here the **charter** artefact is compromised by: **artefact exists but is outdated relative to current release**.
