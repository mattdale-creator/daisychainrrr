# enterprise-cycles-longer → detect

**Full path:** `05-business/unit-economics/enterprise-cycles-longer/detect`

## Purpose
Operational leaf for the `enterprise-cycles-longer` eventuality: **detect**.
