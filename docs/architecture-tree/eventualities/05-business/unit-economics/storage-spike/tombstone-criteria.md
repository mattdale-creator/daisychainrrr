# storage-spike → tombstone-criteria

**Full path:** `05-business/unit-economics/storage-spike/tombstone-criteria`

## Purpose
Operational leaf for the `storage-spike` eventuality: **tombstone-criteria**.
