# charity-vs-entity-misalign → detect

**Full path:** `05-business/fundraising/charity-vs-entity-misalign/detect`

## Purpose
Operational leaf for the `charity-vs-entity-misalign` eventuality: **detect**.
