# charity-vs-entity-misalign → respond

**Full path:** `05-business/fundraising/charity-vs-entity-misalign/respond`

## Purpose
Operational leaf for the `charity-vs-entity-misalign` eventuality: **respond**.
