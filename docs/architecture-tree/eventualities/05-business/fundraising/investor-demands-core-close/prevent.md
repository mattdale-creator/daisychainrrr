# investor-demands-core-close → prevent

**Full path:** `05-business/fundraising/investor-demands-core-close/prevent`

## Purpose
Operational leaf for the `investor-demands-core-close` eventuality: **prevent**.
