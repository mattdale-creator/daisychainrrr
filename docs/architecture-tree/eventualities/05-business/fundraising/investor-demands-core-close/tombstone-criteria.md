# investor-demands-core-close → tombstone-criteria

**Full path:** `05-business/fundraising/investor-demands-core-close/tombstone-criteria`

## Purpose
Operational leaf for the `investor-demands-core-close` eventuality: **tombstone-criteria**.
