# investor-demands-core-close → detect

**Full path:** `05-business/fundraising/investor-demands-core-close/detect`

## Purpose
Operational leaf for the `investor-demands-core-close` eventuality: **detect**.
