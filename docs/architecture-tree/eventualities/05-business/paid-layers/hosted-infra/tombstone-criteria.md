# hosted-infra → tombstone-criteria

**Full path:** `05-business/paid-layers/hosted-infra/tombstone-criteria`

## Purpose
Operational leaf for the `hosted-infra` eventuality: **tombstone-criteria**.
