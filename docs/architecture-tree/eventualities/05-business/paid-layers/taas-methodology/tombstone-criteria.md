# taas-methodology → tombstone-criteria

**Full path:** `05-business/paid-layers/taas-methodology/tombstone-criteria`

## Purpose
Operational leaf for the `taas-methodology` eventuality: **tombstone-criteria**.
