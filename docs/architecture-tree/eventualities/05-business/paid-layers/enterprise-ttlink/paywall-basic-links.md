# enterprise-ttlink → paywall-basic-links

**Path:** `05-business/paid-layers/enterprise-ttlink/paywall-basic-links`

## Failure mode
paywall-basic-links for paid SKU **enterprise-ttlink**.
