# enterprise-ttlink → tombstone-criteria

**Full path:** `05-business/paid-layers/enterprise-ttlink/tombstone-criteria`

## Purpose
Operational leaf for the `enterprise-ttlink` eventuality: **tombstone-criteria**.
