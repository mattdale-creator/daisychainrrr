# enterprise-ttlink → private-index-leaks-to-public

**Path:** `05-business/paid-layers/enterprise-ttlink/private-index-leaks-to-public`

## Failure mode
private-index-leaks-to-public for paid SKU **enterprise-ttlink**.
