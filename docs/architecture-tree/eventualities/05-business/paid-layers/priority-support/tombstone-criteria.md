# priority-support → tombstone-criteria

**Full path:** `05-business/paid-layers/priority-support/tombstone-criteria`

## Purpose
Operational leaf for the `priority-support` eventuality: **tombstone-criteria**.
