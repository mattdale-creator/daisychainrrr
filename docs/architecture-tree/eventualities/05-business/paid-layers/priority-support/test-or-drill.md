# priority-support → test-or-drill

**Full path:** `05-business/paid-layers/priority-support/test-or-drill`

## Purpose
Operational leaf for the `priority-support` eventuality: **test-or-drill**.
